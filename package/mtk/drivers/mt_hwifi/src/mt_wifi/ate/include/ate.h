...
typedef struct _QUEUE_HEADER *PQUEUE_HEADER;
typedef struct _QUEUE_ENTRY *PQUEUE_ENTRY;
typedef struct _TX_BLK TX_BLK;
...
#define SERV_ON(_p) ((_p->serv.serv_id == SERV_HANDLE_TEST)	\
		&& (((((struct service_test *)(_p->serv.serv_handle))->test_config.op_mode)  \
...
#define TESTMODE_BAND2 2
#define PHY_CR_PERBAND_OFFSET(_band_idx)	((_band_idx) ? ((_band_idx == TESTMODE_BAND1) ? 0x10000 : 0x100000) : 0)
#define MAC_CR_PERBAND_OFFSET(_band_idx)	((_band_idx) ? ((_band_idx == TESTMODE_BAND1) ? 0x10000 : 0x1000000) : 0)
...
#define TESTMODE_BAND_NUM CFG_WIFI_RAM_BAND_NUM
...
struct _ATE_OPERATION {
	...
	INT32 (*PreCalBellwether)(struct _RTMP_ADAPTER *pAd, UINT8 op);
	INT32 (*TxDPDBellwether)(struct _RTMP_ADAPTER *pAd, UINT8 op);
