...
#endif
#ifdef MT7990
#include "chip/mt7990_coda/bn0_wf_agg_top.h"
#include "chip/mt7990_coda/bn1_wf_agg_top.h"
#include "chip/mt7990_coda/bn0_wf_tmac_top.h"
#include "chip/mt7990_coda/bn1_wf_tmac_top.h"
#include "chip/mt7990_coda/bn0_wf_arb_top.h"
#include "chip/mt7990_coda/bn1_wf_arb_top.h"
#endif
...
INT32 mtf_ate_mac_cr_restore(RTMP_ADAPTER *ad)
{
	if (IS_AXE(ad) || IS_MT7915(ad) || IS_MT7986(ad) || IS_MT7916(ad) || IS_MT7981(ad)
		|| IS_BELLWETHER(ad) || IS_MT7990(ad) || IS_MT7992(ad) || IS_MT7993(ad)) {
