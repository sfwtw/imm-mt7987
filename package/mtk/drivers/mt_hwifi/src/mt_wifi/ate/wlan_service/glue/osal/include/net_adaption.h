...
#define TEST_MAX_BAND_NUM 3

//this enum can be extended to any size bigger than "TEST_CHIP_BAND_NUM"
enum TEST_BAND_IDX {
	TEST_BAND0 = 0,
	TEST_BAND1,
	TEST_BAND2,
...
#define GET_MAX_PATH(_mcs_nss, _band_idx, _tx_rx) \
		(_mcs_nss->max_path[_tx_rx])
...
/* Test TXD BW160 option */
#define TEST_TXD_BW160 		0x3
...
enum test_bw_type {
	...
	TEST_BW_160C,
	TEST_BW_160NC,
	TEST_BW_0_5,//align QA tooL
	TEST_BW_1,//align QA tooL
	TEST_BW_6,//align QA tooL
	TEST_BW_7,//align QA tooL
	TEST_BW_8,//align QA tooL
	TEST_BW_320,
	TEST_BW_NUM
};
...
/* TXD phy mode definition */
enum txd_tx_mode_type {
	TXD_TX_MODE_CCK = 0,
	TXD_TX_MODE_OFDM,
	TXD_TX_MODE_HTMIX,
	TXD_TX_MODE_HTGREENFIELD,
	TXD_TX_MODE_VHT = 4,
	TXD_TX_MODE_PLR = 5,
	TXD_TX_MODE_HE_SU = 8,
	TXD_TX_MODE_HE_ER,
	...
	TXD_TX_MODE_HE_MU,
	//EHT
	TXD_TX_MODE_EHT_TB = 14,
	TXD_TX_MODE_EHT_MU = 15,
	TXD_TX_MODE_NUM
};
...
/* Indication Specific */
enum {
	INDN_SPEC_FULL_CAL		= 0x00100000,
	INDN_SPEC_RX_CAL_BYPASS_TXITEM	= 0x00200000,
	INDN_SPEC_POWER_CAL		= 0x00400000,
};
...
/* FIXME: check endian for bellwether */
...
struct test_rx_stat_band_info {
	...
	u_int32 phy_alr_pd_count;
	u_int32 mac_rx_u2m_mpdu_count;
	u_int32 mpdu_cnt;
	u_int32 mpdu1_cnt;
	u_int32 Reserved[14];
};
...
struct test_rx_stat_comm_info {
	...
	u_int32 ne_var_db_all_user;
};

/* Test rx stat */
struct test_rx_stat {
	struct test_rx_stat_band_info rx_st_band[TEST_MAX_BAND_NUM];
...
/* TRX packet condition */
struct test_TxRxcondition {
	u_int8 isSingleUserWTBL;
	u_int8 isTB;
	u_int8 isMU;
	u_int8 isEHT;
...
#define SUB20_NUM 8
#define UNUSED_RU 0xFF

struct test_ru_allocatoin {
	/* maximum 8 sub-20MHz for 160/80+80 MHz bandwidth */
	u_int8 sub20[SUB20_NUM];
};
#else //Bellwether : TODO
#define SUB20_NUM 16 /*for BW320*/
#define UNUSED_RU 0xFFFF

struct test_ru_allocatoin {
	/* maximum 8 sub-20MHz for 160/80+80 MHz bandwidth */
	u_int16 sub20[SUB20_NUM];
};
...
struct test_configuration {
	...
	struct test_TxRxcondition trcond;
	...
	u_int16 user_idx;
	u_int16 preampunc;
	u_int32 wlan_id_offset;
	u_int32 indication_specific;

	/* Tx power */
	struct test_txpwr_param pwr_param;
	s_int8 tx_pwr[TEST_ANT_NUM];
	u_int16 ch_pwr_offset[TEST_ANT_NUM];
	u_int16 cvt_pwr_offset[TEST_ANT_NUM];
	...
	u_char  iBFCalStatus;
/* FIXME: check Security for bellwether */
	/*Security Mode*/
	u_char tc_cipher_mode;
	u_char tc_key_id;
	u_int16 tc_key_len;
...
#define TEST_FREE_BLOCK_SIZE 20
struct test_eeprom {
	u_int32 offset;
	/* For read/write bulk cr usage */
	u_int32 length;
	...
	/*For storing Buffer Bin Mode Value */
	u_int8 bufferBinVal;
	/* For free block format v2 */
	u_int8 free_block_format_ver;
	u_int32 efuse_total_bank_num;
	u_int32 free_block_v2[TEST_FREE_BLOCK_SIZE];
	u_int32 total_block_v2[TEST_FREE_BLOCK_SIZE];
	u_int32 efuse_num_v2[TEST_FREE_BLOCK_SIZE];
};
...
struct _net_testmode_chip_info {
	u_int8 u1chip_band_num;
	u_int8 au1used_band[TEST_MAX_BAND_NUM];
	u_int8 band_used_num;
	u_int8 pAd_band_idx;
	u_int32 u4ChipId;
	u_int8 u1testmode_sup_mlo;
};
...
struct test_operation {
	...
	s_int32 (*op_set_tx_pwr)(
		...
		u_char band_idx,
		struct test_txpwr_param *pwr_param);
	s_int32 (*op_set_ch_pwr_offset)(
		struct test_wlan_info *winfos,
		struct test_configuration *configs,
		u_char band_idx,
		struct test_txpwr_param *pwr_param);
	s_int32 (*op_set_cvt_pwr_offset)(
		struct test_wlan_info *winfos,
		struct test_configuration *configs,
		u_char band_idx,
		struct test_txpwr_param *pwr_param);
	...
	s_int32 (*op_set_test_mode_dnlk_5g)(
		struct test_wlan_info *winfos);
	s_int32 (*op_set_test_mode_rxgaink)(
		struct test_wlan_info *winfos,
		u_char band_idx);
	...
	s_int32 (*op_dpd_prek)(
		struct test_wlan_info *winfos,
		u_char mode);
	s_int32 (*op_set_frtbl_info)(
		struct test_wlan_info *winfos,
		struct test_tx_info tx_info,
		u_int8 spe_idx);
	s_int32 (*op_set_preamble_punc_cfg)(
		struct test_wlan_info *winfos,
		u_char band_idx,
		boolean enable,
		u_int16 punc_bmp);
	...
	s_int32 (*op_set_txpwr_power_drop)(
		struct test_wlan_info *winfos,
		s_int8 cPowerDropLevel,
		u_char band_idx);
	s_int32 (*op_set_txpwr_power_percentage)(
		struct test_wlan_info *winfos,
		boolean enable,
		u_char band_idx);
#ifdef TXBF_SUPPORT
	...
	s_int32 (*op_set_manual_assoc)(
		...
		u_char *arg);
#endif
	s_int32 (*op_get_chip_info)(
		struct test_wlan_info *winfos,
		struct _net_testmode_chip_info *ptestmode_chip_info);
	s_int32 (*op_get_rx_sw_count)(
		struct test_wlan_info *winfos,
		u_char band_idx,
...
#define GET_CAPABILITY_VER      0x0007
...
struct test_capability_ph_cap {
	...
	/* BIT0: 11 a/b/g, BIT1: 11n, BIT2: 11ac, BIT3: 11ax, BIT4: 11be*/
	u_int32 protocol;
...
struct test_capability_ext_cap {
	...
	/* BIT7: Bandwidth duplicated mode support */
	u_int32 feature1;
	u_int32 reserved[15];
};
