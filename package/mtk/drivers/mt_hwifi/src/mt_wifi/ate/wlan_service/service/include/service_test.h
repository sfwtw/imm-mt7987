...
#define CONFIG_GET_PARAM(_struct, _member)			\
	(_struct->test_config._member)
#define CONFIG_GET_PADDR(_struct, _member)			\
	(&_struct->test_config._member)
#define CONFIG_SET_PARAM(_struct, _member, _val)		\
	(_struct->test_config._member = _val)
#define CONFIG_SET_PADDR(_struct, _member, _val, _size) ({	\
	struct test_configuration *configs;				\
	configs = &_struct->test_config;			\
...
enum {
	...
	SERV_TEST_TXPWR_SET_CH_PWR_OFFSET,
	SERV_TEST_TXPWR_SET_CVT_PWR_OFFSET,
};
...
enum {
	SERV_TEST_TX_PATH_1 = 1,
	SERV_TEST_TX_PATH_2 = 2,
	SERV_TEST_TX_PATH_3 = 3,
	SERV_TEST_TX_PATH_4 = 4,
	SERV_TEST_TX_PATH_5 = 5
};
...
struct service_test {
	...
	/* Test Rx statistic */
	struct test_rx_stat test_rx_statistic[TEST_MAX_BAND_NUM];
...
s_int32 mt_serv_set_freq_offset(
	struct service_test *serv_test, u_int32 type,
	u_int32 band_idx);
...
s_int32 mt_serv_get_sub_chipid(struct service_test *serv_test, u_int32 *sub_chipid);
...
s_int32 mt_serv_set_txpwr_drop(struct service_test *serv_test,
	s_int8 cPowerDropLevel, u_char band_idx);
s_int32 mt_serv_set_txpwr_percentage(struct service_test *serv_test,
	boolean enable, u_char band_idx);
