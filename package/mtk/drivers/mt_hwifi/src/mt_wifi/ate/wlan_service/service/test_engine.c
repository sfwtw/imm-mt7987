...
static struct test_datalen_limit_map datalen_limit[] = {
	...
	{TEST_MODE_VHT,			6144}, // TEST_MODE_VHT
	{0},	/* reserved */ // TEST_MODE_HE_24G
	{0},	/* reserved */ // TEST_MODE_HE_5G
	{0},	/* reserved */ // ?
	{TEST_MODE_HE_SU,		6144}, // TEST_MODE_HE_SU
	{TEST_MODE_HE_ER,		6144}, // TEST_MODE_HE_ER
	{TEST_MODE_HE_MU,		6144}, // TEST_MODE_HE_TB
	{TEST_MODE_HE_TB,		6144}, // TEST_MODE_HE_MU
	{TEST_MODE_VHT_MIMO,	6144}, // TEST_MODE_VHT_MIMO
	{TEST_MODE_EHT_MU_DL_SU,		6144}, // TEST_MODE_EHT_MU_DL_SU
	{TEST_MODE_EHT_MU_UL_SU,		6144}, // TEST_MODE_EHT_MU_UL_SU
	{TEST_MODE_EHT_MU_DL_OFDMA,		6144}, // TEST_MODE_EHT_MU_DL_OFDMA
	{TEST_MODE_EHT_TB_UL_OFDMA,		6144}, // TEST_MODE_EHT_TB_UL_OFDMA
};
...
static struct test_he_ru_const test_ru_const[] = {
	{37, 24, 12, 6, 2}, // RU26
	{53, 48, 24, 12, 6}, // RU52
	{61, 102, 51, 24, 12},// RU106
	{65, 234, 117, 60, 30},// RU242
	{67, 468, 234, 120, 60},// RU424
	{68, 980, 490, 240, 120},// RU996
	{69, 1960, 980, 492, 246},// RU996 * 2
	{70, 3920, 1960, 984, 492},// RU996 * 4
	{82, 72, 36, 18, 8},// RU52+26
	{90, 126, 63, 30, 14},// RU106+26
	{94, 702, 351, 180, 90},// RU484+242
	{96, 1448, 724, 360, 180},// RU996+484
	{100, 1682, 841, 420, 210},// RU996+484+242
	{104, 2428, 1214, 612, 306},// RU2*996+484
	{105, 2940, 1470, 732, 366},// RU3*996
	{107, 3408, 1704, 852, 426},// RU3*996+484
};


static struct test_tx_mode_fr_map tx_mode_mcs_2_fr_map[] = {
	{TEST_MODE_CCK,			{0x00, 0x01, 0x02, 0x03, 0, 0, 0, 0, 0, 0x05, 0x06, 0x07}},
	{TEST_MODE_OFDM,		{0x0b, 0x0f, 0x0a, 0x0e, 0x09, 0x0d, 0x08, 0x0c}},
	{TEST_MODE_HTMIX,		{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,	//0x00~0x0f
							0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 	//0x10~0x1f
							0x20}},
	{TEST_MODE_HTGREENFIELD, {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,	//0x00~0x0f
							0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,		//0x10~0x1f
							0x20}},
	{TEST_MODE_VHT,			{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09}},
	{0},	/* reserved */
	{0},	/* reserved */
	{0},	/* reserved */
	{TEST_MODE_HE_SU,		{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x00, 0x00, 0x00, 0x00, 	//0x00~0x0f
							0x10, 0x11}},
	{TEST_MODE_HE_ER,		{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,	//0x00~0x0f
							0x10, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,		//0x10~0x1f
							0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,		//0x20~0x2f
							0x30}},
	{TEST_MODE_HE_TB,		{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,	//0x00~0x0f
							0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,		//0x10~0x1f
							0x10, 0x11}},
	{TEST_MODE_HE_MU,		{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,	//0x00~0x0f
							0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,		//0x10~0x1f
							0x10, 0x11}},
};

// [14] : STBC  , [13:10] : NSS , [9:6]: TXMOD , [5:0]: rate
#define	TXD_TX_RATE_MASK_STBC 0x1
#define	TXD_TX_RATE_MASK_NSS 0xF
#define	TXD_TX_RATE_MASK_MODE 0xF
#define TXD_TX_RATE_MASK_RATE 0x3F

#define TXD_TX_RATE_BIT_STBC_FR_TABLE 14
#define	TXD_TX_RATE_BIT_NSS 10
#define TXD_TX_RATE_BIT_MODE 6


#define TESTMODE_TMI_TX_RATE_VHT_VAL(_nss, _mcs, _stbc) \
	(((_stbc) << TXD_TX_RATE_BIT_STBC_FR_TABLE) |\
	(((_nss - 1) & (TXD_TX_RATE_MASK_NSS)) << TXD_TX_RATE_BIT_NSS) | \
	(TEST_MODE_VHT << TXD_TX_RATE_BIT_MODE) | \
	(_mcs))

#define TESTMODE_TMI_TX_RATE_HE_VAL(_mode, _nss, _mcs, _stbc) \
	(((_stbc) << TXD_TX_RATE_BIT_STBC_FR_TABLE) |\
	(((_nss - 1) & (TXD_TX_RATE_MASK_NSS)) << TXD_TX_RATE_BIT_NSS) | \
	...
	u_int8 ru_index, u_int8 dcm)
{
	...
	for (idx = 0 ; idx < SERV_ARRAY_SIZE(test_ru_const) ; idx++) {
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
			("%s: RU Index:[%d],max:%d\n",
			__func__, ru_index, test_ru_const[idx].max_index));
	...
	u_char gi, s_int32 dbps, s_int32 tx_time)
{
	...
	if (nss < ARRAY_SIZE(test_ltf_sym) && ltf < ARRAY_SIZE(test_he_t_ltf_sym_x5))
		ltf_time = test_ltf_sym[nss]*test_he_t_ltf_sym_x5[ltf];
	else {
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
			("%s: nss or ltf is invalid\n", __func__));
		return SERV_STATUS_ENGINE_FAIL;
	}
...
static s_int32 mt_engine_calc_txlen(
	u_char tx_mode, u_char sgi,
	struct test_tx_info *tx_info,
	u_int32 tx_time,
	struct test_ru_info *ru_info)
{
	s_int32 ret = SERV_STATUS_SUCCESS;
	u_int32 txlen = 0, tx_data_rate = 0;
	u_char mcs, mcs_1ss, nss = 1;
	u_char bw = 0, bw_fact = 1;
	...
	if (tx_mode == TEST_MODE_CCK) {
		...
		txlen = tx_time * tx_data_rate / 1000 / 8;
		...
		/* Transfer from bit to byte with expected tx time */
		txlen = tx_time * tx_data_rate / 10 / 8;
		...
		if (bw == TEST_BW_20) {
			...
			|| bw == TEST_TXD_BW160 || (bw == TEST_BW_10)) {
		...
		/* Transfer from bit to byte with expected tx time */
		txlen = tx_time * tx_data_rate / 10 / 8;
	} else if ((tx_mode == TEST_MODE_HE_TB) || (tx_mode == TEST_MODE_EHT_TB_UL_OFDMA)) {
		...
		if (ru_info != NULL) {
			...
			if (ds) {
				...
				nss = ru_info->nss;
				if (mcs < ARRAY_SIZE(test_he_bpscs))
				...
				if (mcs < ARRAY_SIZE(test_he_rate_density)) {
	...
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
		("txlen=%d, tx_time=%d, tx_data_rate=%d\n",
		txlen, tx_time, tx_data_rate));
	...
	tx_info->mpdu_info.tx_len = txlen;

	return ret;
}

static s_int32 mt_engine_calc_hlen(
	u_char tx_mode, struct tx_mpdu_info *mpdu_info)
{
	s_int32 ret = SERV_STATUS_SUCCESS;
	u_int32 hlen = TEST_DEFAULT_MAC_HDR_LEN;
	...
	if (mpdu_info->tx_len > TEST_MAX_MSDU_LEN) {
		if (tx_mode > TEST_MODE_OFDM) {
			mpdu_info->need_qos = TRUE;
			/* mark need_amsdu to notify A-MSDU like packet */
			mpdu_info->need_amsdu = TRUE;
		}

		if (tx_mode < ARRAY_SIZE(datalen_limit) && mpdu_info->tx_len > datalen_limit[tx_mode].amsdu_limit)
			mpdu_info->need_ampdu = TRUE;
	} else if ((tx_mode == TEST_MODE_HE_TB) || (tx_mode == TEST_MODE_EHT_TB_UL_OFDMA))
		mpdu_info->need_qos = TRUE;
	...
	if (tx_mode == TEST_MODE_VHT_MIMO || tx_mode == TEST_MODE_HE_MU ||
		(tx_mode == TEST_MODE_EHT_MU_DL_OFDMA)) {
		mpdu_info->need_qos = TRUE;
		mpdu_info->need_ampdu = TRUE;
	}
	...
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("%s: header len=%d -> %d\n", __func__,
		mpdu_info->hdr_len, hlen));
	mpdu_info->hdr_len = hlen;
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("%s: packet length=%d,\n", __func__, mpdu_info->tx_len));
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("\t\t\t\tqos/amsdu/ampdu=%d/%d/%d\n",
		mpdu_info->need_qos, mpdu_info->need_amsdu,
		mpdu_info->need_ampdu));

	return ret;
}

static s_int32 mt_engine_calc_ampdu(
...
{
	s_int32 ret = SERV_STATUS_SUCCESS;
	u_int32 per_mpdu_len;
	u_int8 agg_cnt = 0;

	if (tx_mode < ARRAY_SIZE(datalen_limit))
		per_mpdu_len = datalen_limit[tx_mode].amsdu_limit;
	else {
		ret = SERV_STATUS_ENGINE_FAIL;
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
			("%s: tx_mode is invalid.\n",
			__func__));
		return ret;
	}
	agg_cnt = mpdu_info->tx_len / per_mpdu_len;

	if (mpdu_info->tx_len % per_mpdu_len)
		agg_cnt++;

	mpdu_info->msdu_len = engine_ceil(mpdu_info->tx_len, agg_cnt);
	mpdu_info->mpdu_cnt = agg_cnt;

	return ret;
}

static s_int32 mt_engine_prepare_burst(
	struct test_wlan_info *winfos,
	struct test_configuration *configs,
	struct tx_mpdu_info *mpdu_info,
	struct test_operation *ops,
	u_char *buf)
{
	 ...
	 */
	if (need_ampdu) {
		ret = mt_engine_calc_ampdu(winfos, configs->tx_mode,
					   mpdu_info, ops, buf);
		 ...
		 */
		mpdu_info->msdu_len = mpdu_info->tx_len;
	}

	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		 ("txlen/msdu len/agg cnt=%d/%d/%d\n",
		  mpdu_info->tx_len, mpdu_info->msdu_len,
		  mpdu_info->mpdu_cnt));
...
static s_int32 mt_engine_prepare_tx(
	struct test_wlan_info *winfos,
	struct test_configuration *configs,
	struct test_operation *ops,
	struct test_tx_info *tx_info,
	u_char *buf)
{
	...
	/* reset first */
	tx_info->mpdu_info.need_qos = 0;
	tx_info->mpdu_info.need_amsdu = 0;
	tx_info->mpdu_info.need_ampdu = 0;
	tx_info->mpdu_info.mpdu_cnt = 1;
	pkt_tx_time = tx_time_param->pkt_tx_time;

	if (pkt_tx_time > 0) {
		tx_info->mpdu_info.need_ampdu = TRUE;
		ret = mt_engine_calc_txlen(configs->tx_mode,
						configs->sgi,
						tx_info,
						pkt_tx_time,
						&configs->ru_info_list[0]);

		if (tx_info->mpdu_info.tx_len == 0) {
			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
	...
	ret = mt_engine_calc_hlen(configs->tx_mode, &tx_info->mpdu_info);

	if (ret != SERV_STATUS_SUCCESS)
		goto err_out;

	ret = mt_engine_prepare_burst(winfos, configs, &tx_info->mpdu_info,
					ops, buf);
	if (ret)
		goto err_out;

	if (tx_info->mpdu_info.need_ampdu) {
		/* Update WTBL first */
		ret = net_ad_cfg_wtbl(winfos, configs, tx_info);
		if (ret)
			goto err_out;
	}
...
err_out:
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("%s: ipg=%d,slot_time=%d,sifs_time=%d,aifsn=%d,cw=%d,ret=0x%x\n",
		__func__, ipg, slot_time, sifs_time, aifsn, cw, ret));
...
static s_int32 mt_engine_stack_lookup(
	struct test_configuration *configs,
	void *virtual_wtbl)
{
	u_int8 stack_seq = 0;
	...
	for (stack_seq = 0;
		stack_seq < configs->stack.index && stack_seq < MAX_MULTI_TX_STA;
		stack_seq++) {
		if (configs->stack.virtual_wtbl[stack_seq] &&
			(virtual_wtbl ==
			 configs->stack.virtual_wtbl[stack_seq])) {
			ret = stack_seq;
			break;
		}
	}
	...
	struct test_tx_info *tx_info)
{
	...
	if (ret > -1) {
		...
		if (stack->index < stack->entry_limit && stack->index < MAX_MULTI_TX_STA) {
			sys_ad_move_mem(stack->da[stack->index], da,
					SERV_MAC_ADDR_LEN);
	...
	struct test_tx_stack *stack)
{
	...
	if (stack->index > 0 && (stack->index - 1) < MAX_MULTI_TX_STA) {
		stack->virtual_device[stack->index-1] = NULL;
		ret = net_ad_free_pkt(winfos,
				      stack->pkt_skb[stack->index-1]);
		...
		if (ret != SERV_STATUS_SUCCESS) {
			...
			stack->pkt_skb[stack->index-1] = NULL;

		net_ad_free_wtbl(winfos, stack->da[stack->index-1],
				 stack->virtual_wtbl[stack->index-1],
				 &stack->tx_info[stack->index-1]);
		if (ret != SERV_STATUS_SUCCESS) {
			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
				 ("%s: Free wtbl fail(0x%04x)\n",
				  __func__, ret));
		}
		sys_ad_zero_mem(&stack->tx_info[stack->index-1],
				sizeof(struct test_tx_info));
		sys_ad_zero_mem(stack->da[stack->index-1],
				SERV_MAC_ADDR_LEN);
...
static s_int32 mt_engine_store_tx_info(
	...
	struct test_tx_info *tx_info)
{
	s_int32 ret = SERV_STATUS_ENGINE_FAIL, sta_idx = -1;
	...
	if (is_mt_engine_stack_full(configs) == FALSE) {
		...
		if (sta_idx > -1 && sta_idx < MAX_MULTI_TX_STA) {
			...
			tx_info = &stack->tx_info[sta_idx];
			/* fill data to pre-allocated common buffer */
			ret = mt_engine_prepare_tx(winfos,
							configs,
							ops,
							tx_info,
							pate_pkt);
			...
			ret = net_ad_compose_pkt(winfos, configs, sta_idx,
						pate_pkt,
			 ...
			 * user execute txcommit without revert priorly
			 */
...
static u_int8 mt_engine_convert_bw(
	u_int8 TestModeBw)
{
	u_int8 TXD_BW_TABLE[TEST_BW_NUM] = {
		SYS_BW_20,//TEST_BW_20
		SYS_BW_40,//TEST_BW_40
		SYS_BW_80,//TEST_BW_80
		SYS_BW_20,//TEST_BW_10
		SYS_BW_20,//TEST_BW_5
		SYS_BW_160,//TEST_BW_160C
		SYS_BW_160,//TEST_BW_160NC
		SYS_BW_20,//TEST_BW_0_5,//align QA tooL
		SYS_BW_20,//TEST_BW_1,//align QA tooL
		SYS_BW_20,//TEST_BW_6,//align QA tooL
		SYS_BW_20,//TEST_BW_7,//align QA tooL
		SYS_BW_20,//TEST_BW_8,//align QA tooL
		SYS_BW_320,//TEST_BW_320
	};

	if (TestModeBw < TEST_BW_NUM)
		return TXD_BW_TABLE[TestModeBw];
...
static u_int8 mt_engine_get_gi_ltf(
	u_int8 QA_tx_mode,
	u_int32 QA_ltf_gi,
	u_int8 *ptx_mode,
	u_int8 *pgi,
...
#define EHT_SU_MODE TXD_TX_MODE_EHT_MU
#define EHT_TB_MODE TXD_TX_MODE_EHT_TB

	struct s_Engine_GiLtf_Mapping {
		u_int8 QA_tx_mode;
		u_int8 QA_LTF_GI;
		u_int8 txmode;
		u_int8 LTF;
	...
	static struct s_Engine_GiLtf_Mapping GiLtfTable[] = {

		{TEST_MODE_EHT_MU_DL_SU, 0, EHT_SU_MODE, TEST_HE_LTF_X2, TEST_GI_8},
		{TEST_MODE_EHT_MU_DL_SU, 1,	EHT_SU_MODE, TEST_HE_LTF_X2, TEST_GI_16},
		{TEST_MODE_EHT_MU_DL_SU, 2,	EHT_SU_MODE, TEST_HE_LTF_X4, TEST_GI_32},
		{TEST_MODE_EHT_MU_DL_SU, 3,	EHT_SU_MODE, TEST_HE_LTF_X4, TEST_GI_8},

		{TEST_MODE_EHT_MU_UL_SU, 0, EHT_SU_MODE, TEST_HE_LTF_X2, TEST_GI_8},
		{TEST_MODE_EHT_MU_UL_SU, 1, EHT_SU_MODE, TEST_HE_LTF_X2, TEST_GI_16},
		{TEST_MODE_EHT_MU_UL_SU, 2, EHT_SU_MODE, TEST_HE_LTF_X4, TEST_GI_32},
		{TEST_MODE_EHT_MU_UL_SU, 3,	EHT_SU_MODE, TEST_HE_LTF_X4, TEST_GI_8},

		{TEST_MODE_EHT_MU_DL_OFDMA, 0, EHT_SU_MODE, TEST_HE_LTF_X2, TEST_GI_8},
		{TEST_MODE_EHT_MU_DL_OFDMA, 1, EHT_SU_MODE, TEST_HE_LTF_X2, TEST_GI_16},
		{TEST_MODE_EHT_MU_DL_OFDMA, 2, EHT_SU_MODE, TEST_HE_LTF_X4, TEST_GI_8},
		{TEST_MODE_EHT_MU_DL_OFDMA, 3, EHT_SU_MODE, TEST_HE_LTF_X4, TEST_GI_32},

		{TEST_MODE_EHT_TB_UL_OFDMA, 0, EHT_TB_MODE, TEST_HE_LTF_X1, TEST_GI_16},
		{TEST_MODE_EHT_TB_UL_OFDMA, 1, EHT_TB_MODE, TEST_HE_LTF_X2, TEST_GI_16},
		{TEST_MODE_EHT_TB_UL_OFDMA, 2, EHT_TB_MODE, TEST_HE_LTF_X4, TEST_GI_32},
	...
	if (pgi && pltf && ptx_mode) {
		// mapping LTF + GI
		for (cnt1 = 0; cnt1 < sizeof(GiLtfTable)/sizeof(struct s_Engine_GiLtf_Mapping); ++cnt1) {
			if ((QA_tx_mode == GiLtfTable[cnt1].QA_tx_mode) && (QA_ltf_gi == GiLtfTable[cnt1].QA_LTF_GI)) {
				*pgi = GiLtfTable[cnt1].GI;
				*pltf = GiLtfTable[cnt1].LTF;
				*ptx_mode = GiLtfTable[cnt1].txmode;
				SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
					("%s: mapping GI:%d,LTF:%d,txmode:%d!\n", __func__, *pgi, *pltf, *ptx_mode));
				break;
			}
		}
	}
	...
	u_int32 ru_index)
{
	...
	if ((alloc_info->sub20[sub_band_idx] != allocation)
		...
		if ((alloc_info->sub20[sub_band_idx] == 0xff) ||
			(alloc_info->sub20[sub_band_idx] == 0xffff)) {
			alloc_info->sub20[sub_band_idx] = allocation;
	...
	struct test_configuration *configs)
{
	...
	for (alloc_idx = 0 ; alloc_idx < sizeof(*alloc_info) ; alloc_idx++) {
		/* D1.0, Table 36-35, 0x28 is 242-tone RU */
		if (alloc_info->sub20[alloc_idx] == UNUSED_RU) {
			if (configs->trcond.isEHT)
				/* D1.0, Table 36-35, 28 is 242-tone RU */
				alloc_info->sub20[alloc_idx] = 28;
			else
	...
	u_char rate_den, u_int32 apep_length)
{
	...
	if (rate < ARRAY_SIZE(test_he_bpscs)) {
	...
	struct test_ru_info *ru_info, u_char ltf_gi, u_char max_pe)
{
	...
	if (nss < ARRAY_SIZE(test_ltf_sym) && ltf_gi < ARRAY_SIZE(test_he_t_ltf_sym_x5)) {
		ltf_time = test_ltf_sym[nss];
		ltf_time *= test_he_t_ltf_sym_x5[ltf_gi];
	} else {
		ret = SERV_STATUS_ENGINE_FAIL;
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
			("%s: nss or ltf_gi is invalid\n", __func__));
		return ret;
	}
	 ...
	 */
	if (gi >= ARRAY_SIZE(test_he_t_sym_x5) || t_pe >= ARRAY_SIZE(test_he_t_pe_x5)) {
		ret = SERV_STATUS_ENGINE_FAIL;
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
			("%s: gi or t_pe is invalid\n", __func__));
		return ret;
	}
	...
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("\t\t%s: tx_sym(x5):%d, tx_pe(x5):%d , isEHT:%d\n",
		__func__, test_he_t_sym_x5[gi], test_he_t_pe_x5[t_pe], ru_info->isEHT));
	...
	struct test_ru_info *ru_info, u_int8 stbc, u_int8 ltf_gi, u_int8 max_pe)
{
	...
	if ((ru_info->rate & ~BIT(5)) < ARRAY_SIZE(test_he_rate_density))
	...
	u_int8 *p_spe_idx)
{
	...
	while (stack_idx < MAX_MULTI_TX_STA && stack->virtual_wtbl[stack_idx] && (stack_idx < (stack->index))) {
...
s_int32 mt_engine_search_stack(
	...
	void **virtual_wtbl)
{
	s_int32 ret = SERV_STATUS_ENGINE_FAIL;
	struct test_tx_stack *stack = &configs->stack;
	...
	if (stack->index == 0) {
		...
		for (sta_seq = 0 ; sta_seq < stack->index && sta_seq < MAX_MULTI_TX_STA; sta_seq++) {
			if (stack->virtual_wtbl[sta_seq] &&
			    (net_ad_match_wtbl(stack->virtual_wtbl[sta_seq],
					  wcid) == SERV_STATUS_SUCCESS)) {
				ret = SERV_STATUS_SUCCESS;
				*stack_idx = sta_seq;
				*virtual_wtbl = stack->virtual_wtbl[sta_seq];
				break;
			}
		}
	}
	...
	struct test_configuration *configs)
{
	...
	while (is_mt_engine_stack_empty(configs) == FALSE) {
		mt_engine_stack_pop(winfos, &configs->stack);
	}

	return ret;
}

s_int32 mt_engine_txmode2fixrate(
	struct test_tx_info *tx_info,
	struct test_configuration *configs)
{
	s_int32 ret = SERV_STATUS_SUCCESS;
	u_int16 local_fixed_rate = 0;
	u_int16 stbc;
	u_int16 nss;
	u_int16 tmi_rate = 0;
	//u_int16 txd_tx_mode;

	if (tx_info->tx_mode < ARRAY_SIZE(tx_mode_mcs_2_fr_map))
		local_fixed_rate = tx_mode_mcs_2_fr_map[tx_info->tx_mode].fixed_rate[tx_info->mcs];

	stbc = tx_info->stbc;
	stbc = (stbc == TRUE) ? 1 : 0;
	nss = tx_info->nss;

	//mcs = local_fixed_rate;

	if (configs->tx_mode < TEST_MODE_NUM) {

		switch (configs->tx_mode) {
		case TEST_MODE_CCK:
		case TEST_MODE_OFDM:
		case TEST_MODE_HTMIX:
		case TEST_MODE_HTGREENFIELD:
			tmi_rate = ((stbc << TXD_TX_RATE_BIT_STBC_FR_TABLE)) |
				(((nss - 1) & TXD_TX_RATE_MASK_NSS) << TXD_TX_RATE_BIT_NSS) |
				((tx_info->tx_mode << TXD_TX_RATE_BIT_MODE)) |
				((local_fixed_rate));
			break;

		case TEST_MODE_VHT:
			tmi_rate = TESTMODE_TMI_TX_RATE_VHT_VAL(tx_info->nss, local_fixed_rate, stbc);
			break;

		//case TEST_MODE_HE:
		case TEST_MODE_HE_SU:
		case TEST_MODE_HE_ER:
		case TEST_MODE_HE_TB:
		case TEST_MODE_HE_MU:

			tmi_rate = TESTMODE_TMI_TX_RATE_HE_VAL(tx_info->tx_mode, tx_info->nss, local_fixed_rate, stbc);
			break;
		case TEST_MODE_EHT_MU_DL_SU:
		case TEST_MODE_EHT_MU_UL_SU:
		case TEST_MODE_EHT_MU_DL_OFDMA:
		case TEST_MODE_EHT_TB_UL_OFDMA:
		//case TXD_TX_MODE_EHT_TB:
		//case TXD_TX_MODE_EHT_MU:
			tmi_rate = (((stbc & TXD_TX_RATE_MASK_STBC) << TXD_TX_RATE_BIT_STBC_FR_TABLE)) |
			   (((nss - 1) & TXD_TX_RATE_MASK_NSS) << TXD_TX_RATE_BIT_NSS) |
			   (((tx_info->tx_mode & TXD_TX_RATE_MASK_MODE) << TXD_TX_RATE_BIT_MODE)) |
			   ((tx_info->mcs) & TXD_TX_RATE_MASK_RATE);
			break;
		}
	}

	tx_info->fixed_rate = tmi_rate;
	...
	u_int8 ctrl_band_idx)
{
	...
	u_int8 isSingleUserWTBL = 0;
	u_int32 user_num;
	u_int16 preampunc, cnt1;

	sys_ad_zero_mem(&tx_info, sizeof(tx_info));
	sys_ad_zero_mem(&configs->trcond, sizeof(configs->trcond));
	...
	if (configs->duty_cycle > 0) {
		...
		if (ret != SERV_STATUS_SUCCESS)
			SERV_LOG(SERV_DBG_CAT_ENGN,
				 SERV_DBG_LVL_TRACE,
				 ("%s: mt_engine_calc_duty_cycle %d\n",
				  __func__, ret));
	}

	tx_info.tx_mode = configs->tx_mode;
	tx_info.bw = mt_engine_convert_bw(configs->per_pkt_bw);
	tx_info.stbc = configs->stbc;
	tx_info.ldpc = configs->ldpc;
	tx_info.mpdu_info.tx_len = configs->tx_len;
	tx_info.mpdu_info.hdr_len = configs->hdr_len;
	tx_info.gi = mt_engine_decode_gi(configs->tx_mode, configs->sgi);
	tx_info.ltf = mt_engine_decode_ltf(configs->tx_mode, configs->sgi);
	mt_engine_get_gi_ltf(configs->tx_mode, configs->sgi, &tx_info.tx_mode, &tx_info.gi, &tx_info.ltf);
	tx_info.ibf = configs->ibf;
	tx_info.ebf = configs->ebf;

	configs->trcond.isSingleUserWTBL = isSingleUserWTBL = (configs->tx_mode < TEST_MODE_HE_TB) || (configs->tx_mode == TEST_MODE_EHT_MU_DL_SU) || (configs->tx_mode == TEST_MODE_EHT_MU_UL_SU);
	configs->trcond.isTB = (configs->tx_mode == TEST_MODE_HE_TB) || (configs->tx_mode == TEST_MODE_EHT_TB_UL_OFDMA);
	configs->trcond.isMU = (configs->tx_mode == TEST_MODE_HE_MU) || (configs->tx_mode == TEST_MODE_EHT_MU_DL_OFDMA);
	configs->trcond.isEHT = (configs->tx_mode == TEST_MODE_EHT_MU_DL_SU) || (configs->tx_mode == TEST_MODE_EHT_MU_UL_SU) ||
						(configs->tx_mode == TEST_MODE_EHT_MU_DL_OFDMA) || (configs->tx_mode == TEST_MODE_EHT_TB_UL_OFDMA);

	/* handle WTBL */
	if ((isSingleUserWTBL)) {
		/* Single user WTBL */
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
					("%s: single user WTBL , index = %d\n", __func__, configs->stack.index));

		user_num = 1;
		if (ops->op_set_tam_arb)
			ops->op_set_tam_arb(winfos, 0x5);

		if (tx_info.tx_mode == TEST_MODE_CCK) {
			if (configs->mcs & TEST_CCK_SHORT_PREAMBLE)
				net_ad_set_preamble(winfos, TRUE);
			else
				net_ad_set_preamble(winfos, FALSE);

			SERV_LOG(SERV_DBG_CAT_ENGN,
				 SERV_DBG_LVL_TRACE,
				 ("%s: CCK %s\n",
				  __func__,
				  ((configs->mcs & TEST_CCK_SHORT_PREAMBLE) ?
					"short" : "long")));
		}
		tx_info.mcs = configs->mcs;
		tx_info.nss = configs->nss;
		mt_engine_txmode2fixrate(&tx_info, configs);

		if (net_ad_alloc_wtbl(winfos,
				      configs->addr1[0],
				      virtual_device,
				      &virtual_wtbl,
				      &tx_info) == SERV_STATUS_SUCCESS) {

			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
					("%s: single user WTBL ,VD:%p , VW:%p\n", __func__,
					virtual_device, virtual_wtbl));

			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
					 ("%s: tx info FR(%x)(STBC:Nss:Mode:Rate=%x:%x:%x:%x),LTF:GI:LDPC=%x:%x:%x\n", __func__,
					  tx_info.fixed_rate, tx_info.stbc, tx_info.nss, tx_info.tx_mode, tx_info.mcs,
					  tx_info.ltf, tx_info.gi, tx_info.ldpc));
			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_ERROR,
					 ("%s: tx info(AID:BW:IBF:EBF=%x:%x:%x:%x),MPDU txLen:msduLen:mpduCnt:hdrLen=%x:%x:%x:%x\n", __func__,
					  tx_info.aid, tx_info.bw, tx_info.ibf, tx_info.ebf,
					  tx_info.mpdu_info.tx_len, tx_info.mpdu_info.msdu_len, tx_info.mpdu_info.mpdu_cnt, tx_info.mpdu_info.hdr_len));
		...
		if (configs->tx_mode == TEST_MODE_VHT_MIMO)
			tx_info.tx_mode = TXD_TX_MODE_VHT;
		...
		for (idx = 0 ; idx < MAX_MULTI_TX_STA ; idx++) {
			...
			if (ru_info[idx].valid) {
				...
				/* ru_info.aid imply user specify AID,
				 * otherwise use auto-generated
				 */
				if (ru_info[idx].aid)
					tx_info.aid = ru_info[idx].aid;
				else
					tx_info.aid = 0;
		...
		/* handle MU module */
		configs->trcond.CounterUseMU = (user_num > 1) ? 1 : 0;
		if (configs->tx_mode == TEST_MODE_HE_MU ||
			...
			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
				("%s: txconfig[%d]\n",
					__func__, winfos->hw_tx_enable));

			/* Add for QA tool RU info & Rdv tool RU info conflict problem */
			if ((winfos->hw_tx_enable & TX_CFG_FRAME_SKIP) == 0) {
				mt_engine_fill_empty_allocation(&configs->ru_alloc, configs);
				...
				for (tone_idx = 0;
					...
					SERV_LOG(SERV_DBG_CAT_ENGN,
						 SERV_DBG_LVL_ERROR,
						 ("%s: allocation[%d] = 0x%x,user_num = %d\n",
						 __func__,
						 tone_idx,
						 configs->ru_alloc.sub20[tone_idx], user_num));
				}
	...
	if (ops->op_set_ampdu_ba_limit) {
		u_int8 wmm_idx = 0;
		u_int8 ampdu_count = 0, stack_seq = 0;
		...
		for (stack_seq = 0;
			...
			tx_info = &configs->stack.tx_info[stack_seq];
			ampdu_count = engine_max(ampdu_count,
						 tx_info->mpdu_info.mpdu_cnt);
		}

		ret = net_ad_get_wmm_idx(virtual_device, &wmm_idx);
		if (ret)
			goto err_out;
		...
		if (ret)
			...
			SERV_LOG(SERV_DBG_CAT_ENGN,
				 SERV_DBG_LVL_TRACE,
				 ("%s: limit aggregation to %d for WMM%d\n",
				  __func__, ampdu_count, wmm_idx));
	}
	...
	ret = mt_engine_apply_spe_antid(ops, winfos, configs, &spe_idx);
	if (ret != SERV_STATUS_SUCCESS)
		goto err_out;

	/* set preamble puncture*/
	if (configs->trcond.isEHT && ops->op_set_preamble_punc_cfg) {
		preampunc = 0;

		for (cnt1 = 0 ; cnt1 < 8 ; cnt1++) {
			if (configs->preampunc & (0x01 << cnt1)) {
				if (configs->per_pkt_bw == TEST_BW_320)
					preampunc |= (0x03 << (14 - 2 * cnt1));
				else
					preampunc |= (0x01 << (15 - cnt1));
			}
		}
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
				("%s: tool punc=0x%04x, trans punc=0x%04x\n", __func__, configs->preampunc, preampunc));
		ops->op_set_preamble_punc_cfg(winfos, 0, (configs->preampunc != 0), preampunc);
	}

	/* Fix rate table */
	if (ops->op_set_frtbl_info) {
		//tx_info.fixed_rate = 0xFC5;
		ops->op_set_frtbl_info(winfos, tx_info, spe_idx);
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
					 ("%s: fixed rate(%x)(S:N:M:R=%x:%x:%x:%x),LTF:GI:LDPC=%x:%x:%x\n", __func__,
					  tx_info.fixed_rate, tx_info.stbc, tx_info.nss, tx_info.tx_mode, tx_info.mcs,
					  tx_info.ltf, tx_info.gi, tx_info.ldpc));
	}
	...
	u_int32 en_log)
{
	...
	band_idx = testmode_chip_info.pAd_band_idx;

	SERV_LOG(SERV_DBG_CAT_TEST, SERV_DBG_LVL_ERROR,
		("[%s][%d]: band_num = %d, band_idx = %d\n", __func__, __LINE__, band_num, band_idx));
		test_config = configs;
		...
		/*
		 *  Backup original CRs and change to test mode specific CR settings.
		...
		test_config->mps_cb.band_idx = band_idx;
		if (ret)
			goto err;

		/*** Step5: Disable rmac and configure rx filter ***/
		/***        And disalble TMAC as well.	         ***/
		ret = ops->op_set_tr_mac(
				winfos, SERV_TEST_MAC_TXRX, FALSE, band_idx);
		if (ret)
			goto err;
		...
		rx_filter.filterMask = SERV_RX_FILTER_NOT_OWN_BTIM
	...
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
	("%s: init test config, wdev_idx=%u,index = %d\n",
	__func__, test_config->wdev_idx, test_config->stack.index));

	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("%s: enter test mode, wdev_idx=%u,index = %d\n",
		__func__, test_config->wdev_idx, configs->stack.index));
	...
	struct test_log_dump_cb *log_dump)
{
	...
	ret = ops->op_restore_cr(winfos, bks, band_idx, RESTORE_ALL);
	if (ret)
		goto err;
	...
	/* release log dump */
	for (idx = TEST_LOG_RXV; idx < TEST_LOG_TYPE_NUM; idx++) {
		log_cb = &log_dump[idx - 1];

		if (log_cb->entry) {
			sys_ad_free_mem(log_cb->entry);
			log_cb->entry = NULL;

			SERV_OS_FREE_SPIN_LOCK(&log_cb->lock);
...
{
	return net_ad_set_auto_resp(winfos, ops,
				    configs, band_idx, mode);
}
	...
	u_char band_idx)
{
	...
	ret = net_ad_set_device_info(winfos, configs,
					configs->addr3[0], band_idx, 0x1);
	if (ret)
		goto err;

#ifdef TXBF_SUPPORT
	ret = net_ad_set_bss_info(winfos, configs,
					band_idx, configs->addr2[0]);
	...
	dbw = configs->per_pkt_bw;


	if (configs->trcond.isTB) {
		txcfg = (configs->tx_mode == TEST_MODE_HE_TB) ? OP_HETB_TX_CFG : OP_EHTTB_TX_CFG;
		ops->op_hetb_ctrl(winfos, band_idx, txcfg,
				TRUE, dbw, configs->sgi,
	...
	if (ret) {
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("%s: mt_engine_apply_ipg_param ret=0x%x\n",
		__func__, ret));
		goto err;
	}
	...
	SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
		("%s: handle ipg=%u , tx_time=%u\n",
		__func__, ipg, pkt_tx_time));

	if ((pkt_tx_time > 0) || (ipg > 0)) {
		u_int32 round = configs->tx_stat.tx_cnt;
		u_int32 rounded = 0;
		u_int32 round_pkt_cnt = 0;
		u_int32 token_limit = 1;//winfos->pkt_tx_tkid_max / 2;
		...
		for (stack_idx = 0;
			stack_idx < configs->stack.index && stack_idx < MAX_MULTI_TX_STA;
			stack_idx++) {
			struct test_tx_info *tx_info = NULL;
			...
			round_pkt_cnt += tx_info->mpdu_info.mpdu_cnt;
			SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
			 ("%s: mpdu_cnt=%d\n",
			 __func__, tx_info->mpdu_info.mpdu_cnt));
		}
		if (round_pkt_cnt == 0)
			round_pkt_cnt = 1;

		/* 0x8fffffff means TX continuously */
		if (round > (token_limit/round_pkt_cnt))
			round = token_limit / round_pkt_cnt;


		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
			 ("%s: tx_cnt=%d , round=%d,per round pkt(s)=%d\n",
			 __func__, tx_cnt, round, round_pkt_cnt));

		/* prevent refill flow interrupted
		 * and en-queue unlimited retry txd
		 */
		if ((configs->tx_mode == TEST_MODE_HE_MU ||
			configs->tx_mode == TEST_MODE_VHT_MIMO ||
			(configs->tx_mode == TEST_MODE_EHT_MU_DL_OFDMA))
			&& configs->retry) {
			round = 1;
			if (ops->op_set_mu_cnt) {
				ret = ops->op_set_mu_cnt(winfos,
			...
			if (ops->op_trigger_mu_counting) {
				ret = ops->op_trigger_mu_counting(winfos,
						stack->virtual_device[0],
								TRUE);
		...
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
			 ("%s: round=%d, token_limit=%d, ",
			 __func__, round, token_limit));
		SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
			 ("pkt_tx_time=%d, ipg=%d,stack_idx=%d\n",
			 pkt_tx_time, ipg, configs->stack.index));
		...
		for (rounded = 0;
			...
			for (stack_idx = 0;
				...
				tx_info = &stack->tx_info[stack_idx];
				mpdu_cnt = tx_info->mpdu_info.mpdu_cnt;
				...
				while (mpdu_cnt) {
					...
					SERV_LOG(SERV_DBG_CAT_ENGN, SERV_DBG_LVL_TRACE,
						("net_ad_enq_pkt ac_idx=%d,ret =%d\n",
						configs->ac_idx, ret));

					configs->tx_stat.txed_cnt++;
					mpdu_cnt--;
				}
			}
		}
	...
	/* workaround for TX without retry whlie MU/VHT MIMO to prevent:
	...
	if (configs->trcond.isTB) {
		txcfg = (configs->tx_mode == TEST_MODE_HE_TB) ? OP_HETB_TX_START : OP_EHTTB_TX_START;
		ops->op_hetb_ctrl(winfos, band_idx, txcfg,
				TRUE, 0, 0, 0, 0, NULL);
	...
	u_char band_idx)
{
	...
	if ((configs->tx_mode == TEST_MODE_HE_TB) || (configs->tx_mode == TEST_MODE_HE_MU)
		|| (configs->tx_mode == TEST_MODE_EHT_MU_DL_OFDMA) || (configs->tx_mode == TEST_MODE_EHT_TB_UL_OFDMA)) {
		if (ops->op_trigger_mu_counting) {
			ret = ops->op_trigger_mu_counting(winfos,
						stack->virtual_device[0],
	...
	if ((op_mode & OP_MODE_TXFRAME) || (op_mode == OP_MODE_STOP)) {
		...
		if ((pkt_tx_time > 0) || (ipg > 0)) {
			 ...
			 */
			for (sta_seq = 0;
				sta_seq < stack->index && sta_seq < MAX_MULTI_TX_STA;
				sta_seq++) {
				ret = ops->op_set_clean_persta_txq(
					winfos, FALSE,
					stack->virtual_wtbl[sta_seq],
					omac_idx, band_idx);
				if (ret != SERV_STATUS_SUCCESS)
					goto err;
			}
			/* restore TMAC CRs without considering IPG */
			ret = ops->op_restore_cr(winfos, NULL,
						 band_idx, RESTORE_TX);
			if (ret)
				goto err;
		}
	...
	if ((configs->tx_mode == TEST_MODE_HE_TB) || (configs->tx_mode == TEST_MODE_EHT_TB_UL_OFDMA)) {
		txcfg = (configs->tx_mode == TEST_MODE_HE_TB) ? OP_HETB_TX_STOP : OP_EHTTB_TX_STOP;
		ops->op_hetb_ctrl(winfos, band_idx, txcfg,
					TRUE, 0, 0, 0, 0, NULL);
	}
err:
	...
	u_char band_idx)
{
	...
	ret = net_ad_set_device_info(winfos, configs,
					configs->addr3[user_idx], band_idx, 0x1);
	if (ret)
		goto err;
	...
	user_idx = configs->user_idx;
	ret = ops->op_set_rx_user_idx(winfos, band_idx, user_idx);
	if (ret)
		goto err;
	...
	if (configs->tx_mode == TEST_MODE_HE_TB || configs->tx_mode == TEST_MODE_EHT_TB_UL_OFDMA) {
		...
		if (configs->per_pkt_bw == TEST_BW_160C || configs->per_pkt_bw == TEST_BW_160NC)
			ext_bw = 1;
		else if (configs->per_pkt_bw == TEST_BW_320)
			ext_bw = 2;
	...
	(configs->tx_mode == TEST_MODE_EHT_MU_DL_SU) || (configs->tx_mode == TEST_MODE_EHT_MU_UL_SU)
	|| (configs->tx_mode == TEST_MODE_EHT_MU_DL_OFDMA)) {
	...
	u_char band_idx)
{
	...
	/* turn off TMAC due to AutoResp feature will switch TMAC on */
	ret = ops->op_set_tr_mac(
			winfos, SERV_TEST_MAC_TX, FALSE, band_idx);
