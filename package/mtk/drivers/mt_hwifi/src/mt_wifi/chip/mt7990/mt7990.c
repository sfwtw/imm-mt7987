...
#include "mt7990_coda/WF_RX_DESCRIPTOR_BESRA_c_header.h"
#include "mt7990_coda/WF_TX_DESCRIPTOR_BESRA_c_header.h"
#include "mt7990_coda/wf_wfdma_mem_dma.h"

/* iPAiLNA shall always be included as default */
#include "eeprom/mt7990_e2p_iPAiLNA.h"

#ifdef CONFIG_CPE_SUPPORT
#include "eeprom/mt7990_e2p_ePAeLNA.h"
#endif
...
#include "eeprom/mt7990_e2p_iPAeLNA.h"
#endif
#if defined(CONFIG_FIRST_IF_EPAILNA) || defined(CONFIG_SECOND_IF_EPAILNA) || defined(CONFIG_THIRD_IF_EPAILNA)
#include "eeprom/mt7990_e2p_ePAiLNA.h"
#endif

#define MT7990_WIFI_RAM_BAND_NUM 3
#ifdef DOT11V_MBSSID_SUPPORT
#define MT7990_MAX_TRANSMITTED_NUM 4 /* per band support */
#define MT7990_TRANSMITTED_BSS_BITMAP 0x00001111
#endif /* DOT11V_MBSSID_SUPPORT */
/* interrupt pcie 0 */
/* MT7990 TODO: to support wed or not? */
...
*/
const struct PCIE_CHIP_CR_MAPPING mt7990_mac_cr_range[] = {
 ...
 */
uint16_t MT7990_DNL_CAL_GBAND_BW20_FREQ[] = {2412, 2442, 2472};
uint16_t MT7990_DNL_CAL_ABAND_BW20_FREQ[] = {
	4960, 5060,/* Group 1 */
	5180, 5240,/* Group 2 */
	5260, 5320,/* Group 3 */
	5340, 5480,/* Group 4 */
	...
	5660, 5720,/* Group 7 */
	5785, 5845 /* Group 8 */};
uint16_t MT7990_DNL_CAL_BW20_FREQ[] = {
	2412, 2442, 2472,
	4960, 5060, 5180, 5240, 5260, 5320, 5340, 5480,
	5500, 5560, 5580, 5640, 660, 5720, 5785, 5845};

uint16_t MT7990_DNL_CAL_GBAND_BW20_CH[] = {1, 7, 13};
uint16_t MT7990_DNL_CAL_ABAND_BW20_CH[] = {
	192,  12,  36,  48,  52,  64,  68,  96,
	100, 112, 116, 128, 132, 144, 157, 169};
uint16_t MT7990_DNL_CAL_BW20_CH[] = {
	1,   7,  13, 192,  12,  36,  48,  52,  64,  68,
	96, 100, 112, 116, 128, 132, 144, 157, 169};

uint16_t MT7990_DNL_CAL_GBAND_BW20_SIZE =
	(sizeof(MT7990_DNL_CAL_GBAND_BW20_FREQ) / sizeof(uint16_t));
uint16_t MT7990_DNL_CAL_ABAND_BW20_SIZE =
	(sizeof(MT7990_DNL_CAL_ABAND_BW20_FREQ) / sizeof(uint16_t));
uint16_t MT7990_DNL_CAL_BW20_FREQ_SIZE  =
	(sizeof(MT7990_DNL_CAL_BW20_FREQ) / sizeof(uint16_t));

uint16_t MT7990_DNL_CAL_GBAND_BW20_CH_SIZE =
	(sizeof(MT7990_DNL_CAL_GBAND_BW20_CH) / sizeof(uint16_t));
uint16_t MT7990_DNL_CAL_ABAND_BW20_CH_SIZE =
	(sizeof(MT7990_DNL_CAL_ABAND_BW20_CH) / sizeof(uint16_t));
uint16_t MT7990_DNL_CAL_B20_CH_SIZE        =
	(sizeof(MT7990_DNL_CAL_BW20_CH) / sizeof(uint16_t));

static struct rtmp_spe_map mt7990_spe_map[] = {
	/* All */
	{0x0, 0},
	{0xf, 0},
	/* 1 Ant */
...
UINT16 MT7990_PER_CH_A5_BW20_FREQ[] = {
	5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320,
	5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640,
	5660, 5680, 5700, 5720, 5745, 5765, 5785, 5805,
	5825, 5845, 5865, 5885};

UINT16 MT7990_PER_CH_A5_BW160_FREQ[] = {
	5250, 5570, 5815};

UINT16 MT7990_PER_CH_A5_BW20_BW160_FREQ[] = {
	5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320,
	5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640,
	5660, 5680, 5700, 5720, 5745, 5765, 5785, 5805,
	5825, 5845, 5865, 5885,
...
UINT16 MT7990_PER_CH_A5_BW20[] = {
	 36,  40,  44,  48,  52,  56,  60,  64,
	100, 104, 108, 112, 116, 120, 124, 128,
	132, 136, 140, 144, 149, 153, 157, 161,
	165, 169, 173, 177};

UINT16 MT7990_PER_CH_A5_BW160[] = {
	 50, 114, 163};

UINT16 MT7990_PER_CH_A5_BW20_BW160[] = {
	 36,  40,  44,  48,  52,  56,  60,  64,
	100, 104, 108, 112, 116, 120, 124, 128,
	132, 136, 140, 144, 149, 153, 157, 161,
	165, 169, 173, 177,
...
UINT16 MT7990_PER_CH_A6_BW20_FREQ[] = {
...
UINT16 MT7990_PER_CH_A6_BW160_FREQ[] = {
	6025, 6185, 6345, 6505, 6665, 6825, 6985};

UINT16 MT7990_PER_CH_A6_BW320_FREQ[] = {
	6105, 6265, 6425, 6585, 6745, 6905};

UINT16 MT7990_PER_CH_A6_BW20_BW160_FREQ[] = {
	5955, 5975, 5995, 6015, 6035, 6055, 6075, 6095,
	6115, 6135, 6155, 6175, 6195, 6215, 6235, 6255,
	6275, 6295, 6315, 6335, 6355, 6375, 6395, 6415,
	6435, 6455, 6475, 6495, 6515, 6535, 6555, 6575,
...
UINT16 MT7990_PER_CH_A6_BW160[] = {
	 15,  47,  79, 111, 143, 175, 207};

UINT16 MT7990_PER_CH_A6_BW320[] = {
	 31, 63, 95, 127, 159, 191};


UINT16 MT7990_PER_CH_A6_BW20_BW160[] = {
	  1,   5,   9,  13,  17,  21,  25,  29,
	 33,  37,  41,  45,  49,  53,  57,  61,
	 65,  69,  73,  77,  81,  85,  89,  93,
	 97, 101, 105, 109, 113, 117, 121, 125,
...
UINT16 MT7990_PER_CH_G_BW20_FREQ[] = {
	2422, 2442, 2462};

UINT16 MT7990_PER_CH_G_BW20[] = {
	  3,   7,  11};

UINT16 MT7990_PER_CH_A5_BW20_BW160_FREQ_SIZE = sizeof(MT7990_PER_CH_A5_BW20_BW160_FREQ) / sizeof(UINT16);
UINT16 MT7990_PER_CH_A6_BW20_BW160_FREQ_SIZE = sizeof(MT7990_PER_CH_A6_BW20_BW160_FREQ) / sizeof(UINT16);
UINT16 MT7990_PER_CH_G_BW20_FREQ_SIZE  = (sizeof(MT7990_PER_CH_G_BW20_FREQ) / sizeof(UINT16));

UINT16 MT7990_PER_CH_A5_BW20_BW160_SIZE = sizeof(MT7990_PER_CH_A5_BW20_BW160) / sizeof(UINT16);
UINT16 MT7990_PER_CH_A6_BW20_BW160_SIZE = sizeof(MT7990_PER_CH_A6_BW20_BW160) / sizeof(UINT16);
UINT16 MT7990_PER_CH_A5_BW20_SIZE =  sizeof(MT7990_PER_CH_A5_BW20) / sizeof(UINT16);
UINT16 MT7990_PER_CH_A6_BW20_SIZE =  sizeof(MT7990_PER_CH_A6_BW20) / sizeof(UINT16);
UINT16 MT7990_PER_CH_G_BW20_SIZE    = (sizeof(MT7990_PER_CH_G_BW20) / sizeof(UINT16));
UINT16 MT7990_PER_CH_A5_BW160_SIZE =  sizeof(MT7990_PER_CH_A5_BW160) / sizeof(UINT16);
UINT16 MT7990_PER_CH_A6_BW160_SIZE =  sizeof(MT7990_PER_CH_A6_BW160) / sizeof(UINT16);
UINT16 MT7990_PER_CH_A6_BW320_SIZE =  sizeof(MT7990_PER_CH_A6_BW320) / sizeof(UINT16);


#endif /* PRE_CAL_MT7990_SUPPORT */

UINT8 MT7990_SINGLE_SKU_FILL_TABLE_LENGTH[] = {
...
#ifdef TXBF_SUPPORT
#define MT7990_MAX_BFEE_SS 3
#endif
static UINT32 mt7990_get_mib_bcn_tx_cnt(RTMP_ADAPTER *pAd, UINT8 band_idx)
{
	UINT32 value = 0;
	...
	case BAND2:
		MAC_IO_READ32(pAd->hdev_ctrl,
			IP1_BN0_WF_MIB_TOP_TSCR18_BEACONTXCOUNT_ADDR, &value);
		break;
	default:
		MAC_IO_READ32(pAd->hdev_ctrl,
...
#ifdef PRE_CAL_MT7990_SUPPORT
void mt7990_apply_dpd_flatness_data(
	RTMP_ADAPTER          *pAd,
	...
	)
{
	...
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO,
		"---------------------SKU(%x) DoCAL(%x) Band(%x)---------------------\n",
		ph_dev->chipsku, doCal1, pAd->BandSel);
	...
	if (Band == GBAND) {/* 2G */
		upper_bound = MT7990_PER_CH_G_BW20_FREQ_SIZE;
		eeprom_ofst = cap->prek_ee_info.dpd_flash_offset_g_begin;
		for (i = 0; i < upper_bound; i++) {
			if (MT7990_PER_CH_G_BW20_FREQ[i] == CentralFreq) {
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO,
		...
		/* 5G */
		if (pAd->BandSel == BAND_SELECT_5G || pAd->BandSel == BAND_SELECT_5GLOW || pAd->BandSel == BAND_SELECT_5GHIGH) {
			upper_bound = MT7990_PER_CH_A5_BW20_BW160_FREQ_SIZE;
			eeprom_ofst = cap->prek_ee_info.dpd_flash_offset_a5_begin;
			for (i = 0; i < upper_bound; i++) {
				if (MT7990_PER_CH_A5_BW20_BW160_FREQ[i] == CentralFreq) {
					MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO,
						"%d is in DPD-Flatness cal table, index = %d\n",
						CentralFreq, i);
					break;
			...
			upper_bound = MT7990_PER_CH_A6_BW20_BW160_FREQ_SIZE;
			eeprom_ofst = cap->prek_ee_info.dpd_flash_offset_a6_begin;
			for (i = 0; i < upper_bound; i++) {
				if (MT7990_PER_CH_A6_BW20_BW160_FREQ[i] == CentralFreq) {
					MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO,
						"%d is in DPD-Flatness cal table, index = %d\n",
						CentralFreq, i);
					break;
	...
	if (Band == GBAND)
		...
		if (SwChCfg.Bw == BW_160 ||  SwChCfg.Bw == BW_320)
	...
	while (ofst < sendNum) {
		if (Band == GBAND)
			MtCmdSetDpdFlatnessCal_7990(pAd, i * sendNum + ofst, PRE_CAL_SET_MAX_LENGTH, eeprom_ofst, TX_DPD_FLATNESS_CAL);
		else if ((SwChCfg.Bw == BW_160) && (pAd->BandSel == BAND_SELECT_5G || pAd->BandSel == BAND_SELECT_5GLOW || pAd->BandSel == BAND_SELECT_5GHIGH)) {
			BW160_320_ofst = (cap->prek_ee_info.dpd_cal_5g_legacy_size / PRE_CAL_SET_MAX_LENGTH) + (i - MT7990_PER_CH_A5_BW20_SIZE) * sendNum;
			MtCmdSetDpdFlatnessCal_7990(pAd, BW160_320_ofst + ofst, PRE_CAL_SET_MAX_LENGTH, eeprom_ofst, TX_DPD_FLATNESS_CAL_A5_MEM);
		} else if (((SwChCfg.Bw == BW_320) || (SwChCfg.Bw == BW_160)) && (pAd->BandSel == BAND_SELECT_6G || pAd->BandSel == BAND_SELECT_6GLOW || pAd->BandSel == BAND_SELECT_6GHIGH)) {
			BW160_320_ofst = (cap->prek_ee_info.dpd_cal_6g_legacy_size / PRE_CAL_SET_MAX_LENGTH) + (i - MT7990_PER_CH_A6_BW20_SIZE) * sendNum;
			MtCmdSetDpdFlatnessCal_7990(pAd, BW160_320_ofst + ofst, PRE_CAL_SET_MAX_LENGTH, eeprom_ofst, TX_DPD_FLATNESS_CAL_A6_MEM);
		} else if ((SwChCfg.Bw < BW_160) && (pAd->BandSel == BAND_SELECT_5G || pAd->BandSel == BAND_SELECT_5GLOW || pAd->BandSel == BAND_SELECT_5GHIGH)) {
			MtCmdSetDpdFlatnessCal_7990(pAd, i * sendNum + ofst, PRE_CAL_SET_MAX_LENGTH, eeprom_ofst, TX_DPD_FLATNESS_CAL_A5);
		} else {
			MtCmdSetDpdFlatnessCal_7990(pAd, i * sendNum + ofst, PRE_CAL_SET_MAX_LENGTH, eeprom_ofst, TX_DPD_FLATNESS_CAL_A6);
		}
		ofst++;
	}
}
	...
	RTMP_ADAPTER *pAd, MT_SWITCH_CHANNEL_CFG SwChCfg)
{
	...
	MtPwrLimitTblChProc(pAd, SwChCfg.BandIdx, SwChCfg.Channel_Band,
		SwChCfg.ControlChannel, cent_ch);
#endif

#ifdef PRE_CAL_MT7990_SUPPORT
	mt7990_apply_dpd_flatness_data(pAd, SwChCfg);
#endif
...
static UINT32 mt7990_get_sku_decision(RTMP_ADAPTER *ad)
{
	UINT32 reg_val = 0;
	UINT32 is_singal_adie = 0;

	RTMP_IO_READ32(ad->hdev_ctrl, MT7990_CBTOP_GPIO_ADIE_COMBATION_STRAP_ADDR, &reg_val);

	is_singal_adie = (reg_val & MT7990_CBTOP_GPIO_SINGAL_ADIE_STRAP_MASK) >>
			MT7990_CBTOP_GPIO_SINGAL_ADIE_STRAP_SHIF;

	reg_val = (reg_val & MT7990_CBTOP_GPIO_ADIE_COMBATION_STRAP_MASK) >>
			MT7990_CBTOP_GPIO_ADIE_COMBATION_STRAP_SHIF;

	if (is_singal_adie)
		reg_val = MT7990_ADIE_007;

	if (reg_val == MT7990_ADIE_677)
		MTWF_PRINT("\033[1;33mmt7990 sku:%2x ADIE_76_77_77\x1b[m\n", reg_val);
	else if (reg_val == MT7990_ADIE_577)
		MTWF_PRINT("\033[1;33mmt7990 sku:%2x ADIE_75_77_77\x1b[m\n", reg_val);
	else if (reg_val == MT7990_ADIE_607)
		MTWF_PRINT("\033[1;33mmt7990 sku:%2x ADIE_76_x_77\x1b[m\n", reg_val);
	else if (reg_val == MT7990_ADIE_507)
		MTWF_PRINT("\033[1;33mmt7990 sku:%2x ADIE_75_x_77\x1b[m\n", reg_val);
	else if (reg_val == MT7990_ADIE_007)
		MTWF_PRINT("\033[1;33mmt7990 sku:%2x ADIE__x_x_77\x1b[m\n", reg_val);
...
static struct _kfree_def adie_def_7977[] = {
	/* adie efuse offset with FT result.
	   The other indicate that adie0 efuse merge to eeprom offset list */
	{15, {0x4c, 0x4d, 0x4e, 0x4f, 0x50, 0x51, 0x53, 0x55, 0x57, 0x59,
	      0x69, 0x6a, 0x7a, 0x7c, 0x7e}
	},
	/* adie1 efuse merge to eeprom offset list */
	{15, {0x54c, 0x54d, 0x54e, 0x54f, 0x550, 0x551, 0x553, 0x555, 0x557, 0x559,
	      0x569, 0x56a, 0x57a, 0x57c, 0x57e}
	},
	/* adie2 efuse merge to eeprom offset list */
	{15, {0x124c, 0x124d, 0x124e, 0x124f, 0x1250, 0x1251, 0x1253, 0x1255, 0x1257, 0x1259,
	      0x1269, 0x126a, 0x127a, 0x127c, 0x127e}
	}
};
...
static uint8_t is_cal_free_ic(RTMP_ADAPTER *pAd)
{
	...
	sku = mt7990_get_sku_decision(pAd);

	if ((sku == MT7990_ADIE_677) || (sku == MT7990_ADIE_607)) {
		if (sku == MT7990_ADIE_607) {
			/* To identify MT7976C */
			rtmp_ee_efuse_read16(pAd, 0x470, &value);
			ph_dev->EEPROMImage[0x470] = (value & 0xFF);

			/* E3 new binding */
			rtmp_ee_efuse_read16(pAd, 0x471, &value);
			ph_dev->EEPROMImage[0x471] = (value & 0xFF);
		}

		if (sku == MT7990_ADIE_677) {
			rtmp_ee_efuse_read16(pAd, 0x300, &value);
			ph_dev->EEPROMImage[0x300] = (value & 0xFF);
		}

		adie_kfree_def = &adie_def_7976[0];
		ret = is_cal_free_ic_check(pAd, adie_kfree_def, MT7990_ADIE0_OFFSET);
		if (!ret) {
			MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_ERROR,
				 "\x1b[41m MT7990_ADIE_677 607 of 6, iCal merge dismissed! \x1b[m\n");
			goto err_out;
		}

		if (sku == MT7990_ADIE_677) {
			adie_kfree_def = &adie_def_7977[0];
			ret = is_cal_free_ic_check(pAd, adie_kfree_def, MT7990_ADIE1_OFFSET);
			if (!ret) {
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_ERROR,
					"\x1b[41m MT7990_ADIE_677 of 7, iCal merge dismissed! \x1b[m\n");
				goto err_out;
			}
		}
	} else if ((sku == MT7990_ADIE_577) || (sku == MT7990_ADIE_507)) {
		adie_kfree_def = &adie_def_7975[0];
		ret = is_cal_free_ic_check(pAd, adie_kfree_def, MT7990_ADIE0_OFFSET);
		if (!ret) {
			MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_ERROR,
				 "\x1b[41m MT7990_ADIE_577 of 5, iCal merge dismissed! \x1b[m\n");
			goto err_out;
		}

		if (sku == MT7990_ADIE_577) {
			adie_kfree_def = &adie_def_7977[0];
			ret = is_cal_free_ic_check(pAd, adie_kfree_def, MT7990_ADIE1_OFFSET);
			if (!ret) {
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_ERROR,
					"\x1b[41m MT7990_ADIE_577 of 7, iCal merge dismissed! \x1b[m\n");
				goto err_out;
			}
		}
	}
	...
	/* adie2 always check */
	adie_kfree_def = &adie_def_7977[0];
	ret = is_cal_free_ic_check(pAd, adie_kfree_def, MT7990_ADIE2_OFFSET);
	if (!ret) {
		MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_ERROR,
			 "\x1b[41m MT7990_ADIE2 7, iCal merge dismissed! \x1b[m\n");
		goto err_out;
	}
...
static inline VOID cal_free_data_get_from_addr(RTMP_ADAPTER *ad, UINT16 adie_offset, UINT16 ee_offset)
{
	...
	MTWF_DBG(ad, DBG_CAT_HW, CATHW_PHY, DBG_LVL_DEBUG,
...
static VOID cal_free_data_get(RTMP_ADAPTER *ad)
{
	...
	//struct physical_device *ph_dev = ad->physical_dev;
	uint32_t sku = 0, adie_cnt = 3, adie_idx = 0, adie_offset = 0;

	MTWF_DBG(ad, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO, "\n");

	/* A-Die merge */
	sku = mt7990_get_sku_decision(ad);

	for (adie_idx = 0; adie_idx < adie_cnt; adie_idx++) {
		adie_kfree_def = NULL;
		ee_kfree_def = NULL;

		if (adie_idx == 0 && (sku == MT7990_ADIE_677 || sku == MT7990_ADIE_607)) {
			adie_kfree_def = &adie_def_7976[0];
			ee_kfree_def = &adie_def_7976[1];
			adie_offset = MT7990_ADIE0_OFFSET;
		} else if (adie_idx == 0 && (sku == MT7990_ADIE_577 || sku == MT7990_ADIE_507)) {
			adie_kfree_def = &adie_def_7975[0];
			ee_kfree_def = &adie_def_7975[1];
			adie_offset = MT7990_ADIE0_OFFSET;
		}

		if (adie_idx == 1 && (sku == MT7990_ADIE_677 || sku == MT7990_ADIE_577)) {
			adie_kfree_def = &adie_def_7977[0];
			ee_kfree_def = &adie_def_7977[1];
			adie_offset = MT7990_ADIE1_OFFSET;
		}

		/* adie2 always merge */
		if (adie_idx == 2) {
			adie_kfree_def = &adie_def_7977[0];
			ee_kfree_def = &adie_def_7977[2];
			adie_offset = MT7990_ADIE2_OFFSET;
		}
		/* else panta band ? */

		if (adie_kfree_def == NULL || ee_kfree_def == NULL)
			continue;
...
static VOID BBPInit(RTMP_ADAPTER *pAd)
{
	...
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_DEBUG, "todo\n");
}
...
static UINT32 mt7990_get_band_select_from_eeprom(
	struct _RTMP_ADAPTER *pAd)
{
#ifdef PRE_CAL_MT7990_SUPPORT
	struct physical_device *ph_dev = pAd->physical_dev;
	...
	switch (band_idx) {
	case 0:
		ph_dev->chipsku &= ~(CAL_7990_SKU_PHY0_MASK);
		ph_dev->chipsku |= (pAd->BandSel << CAL_7990_SKU_PHY0_SHIFT);
		break;

	case 1:
		ph_dev->chipsku &= ~(CAL_7990_SKU_PHY1_MASK);
		ph_dev->chipsku |= (pAd->BandSel << CAL_7990_SKU_PHY1_SHIFT);
		break;

	case 2:
		ph_dev->chipsku &= ~(CAL_7990_SKU_PHY2_MASK);
		ph_dev->chipsku |= (pAd->BandSel << CAL_7990_SKU_PHY2_SHIFT);
		break;
...
static UINT32 mt7990_get_rx_stat_all(
	struct _RTMP_ADAPTER *pAd,
	uint8_t band_idx,
	uint8_t blk_idx,
...
static UINT32 mt7990_get_rx_stat(
	struct _RTMP_ADAPTER *pAd,
	UCHAR band_idx,
...
static INT32 mt7990_get_chip_capability(
	struct _RTMP_ADAPTER *pAd, struct test_capability *chip_cap)
{
	...
	/* phy idx */
	if (sku == MT7990_ADIE_607 || sku == MT7990_ADIE_507) {
		RTMP_IO_READ32(pAd->hdev_ctrl, MT7990_CBTOP_GPIO_ADIE_COMBATION_STRAP_ADDR, &reg_val);
		if (reg_val & MT7990_CBTOP_GPIO_2ADIE_TRIBAND_STRAP_MASK)
			chip_cap->ph_cap.phy_adie_index |= BITS(0, 2);
		else
			chip_cap->ph_cap.phy_adie_index |= (BIT0 | BIT2);
	} else if (sku == MT7990_ADIE_007) {
		chip_cap->ph_cap.ant_num = 4;
		chip_cap->ph_cap.phy_adie_index |= BIT2;
	} else
		chip_cap->ph_cap.phy_adie_index |= BITS(0, 2);

	/* adie idx */
	if (sku == MT7990_ADIE_607 || sku == MT7990_ADIE_507)
		chip_cap->ph_cap.phy_adie_index |= (BIT8 | BIT10);
	else if (sku == MT7990_ADIE_007)
		chip_cap->ph_cap.phy_adie_index |= BIT10;
	else
		chip_cap->ph_cap.phy_adie_index |= BITS(8, 10);
	...
	/* b2 */
	ad = physical_device_get_mac_adapter_by_band(pAd->physical_dev, BAND2);
	if (ad) {
		mcs_nss = MCS_NSS_CAP(ad);
		...
		if (BandSel == BAND_SELECT_6G || BandSel == BAND_SELECT_6GLOW)
			chip_cap->ph_cap.band_bandwidth |= ((BITS(0, 3) | BIT5) << 16);
		else if (BandSel == BAND_SELECT_5G || BandSel == BAND_SELECT_5GLOW ||
				BandSel == BAND_SELECT_5GHIGH)
			chip_cap->ph_cap.band_bandwidth |= (BITS(0, 1) << 16);
	}
...
static uint8_t mt7990_check_RF_lock_down(RTMP_ADAPTER *pAd)
{
...
static UINT32 mt7990_get_sku_tbl_idx(
...
static uint8_t mt7990_Config_Effuse_Country(RTMP_ADAPTER *pAd)
{
...
static UINT32 mt7990_rxv_entry_hdr_parser(
	struct _RTMP_ADAPTER *pAd,
	VOID *rxv_entry,
...
error0:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"%s(): null pointer for rxv pkt header.\n", __func__);
	return 1;
...
static UINT32 mt7990_rxv_pkt_hdr_parser(
...
static UINT32 mt7990_rxv_get_byte_cnt(
	struct _RTMP_ADAPTER *pAd,
	uint8_t band_idx,
	UINT32 *byte_cnt)
{
...
static UINT32 mt7990_rxv_get_content(
	struct _RTMP_ADAPTER *pAd,
	uint8_t band_idx,
	PVOID *content)
{
...
static UINT32 mt7990_rxv_raw_data_show(
...
static UINT32 mt7990_rxv_info_show(
	struct _RTMP_ADAPTER *pAd, uint8_t band_idx)
{
	return FALSE;
}

static UINT32 mt7990_rxv_stat_reset(
	struct _RTMP_ADAPTER *pAd, uint8_t band_idx)
{
...
static UINT32 mt7990_rxv_cap_init(RTMP_ADAPTER *pAd)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);

	if (IS_MT7990_FW_VER_E1(pAd)) {
	...
	} else if (IS_MT7990_FW_VER_E2(pAd)) {
...
static UINT32 mt7990_rxv_entry_parse(struct _RTMP_ADAPTER *pAd, VOID *Data)
{
...
static UINT32 mt7990_rxv_content_len(struct _RTMP_ADAPTER *pAd, uint8_t type_mask, uint8_t rxv_sta_cnt, uint16_t *len)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
...
static UINT32 mt7990_rxv_dump_start(struct _RTMP_ADAPTER *pAd)
{
...
static UINT32 mt7990_rxv_dump_stop(struct _RTMP_ADAPTER *pAd)
{
	pAd->rxv_dump_ctrl.enable = false;
	return 0;
}

static UINT32 mt7990_rxv_dump_link_list_instl(
...
static UINT32 mt7990_rxv_dump_link_list_remv(struct _RTMP_ADAPTER *pAd, VOID *ptr, RXV_DUMP_LIST_TYPE type)
{
	RXV_DUMP_ENTRY_CONTENT *rxv_dump_entry_content = NULL;
	RXV_DUMP_BASIC_ENTRY *rxv_dump_basic_entry = NULL;
	RXV_DUMP_ENTRY *rxv_dump_entry = NULL;
...
static UINT32 mt7990_rxv_dump_buf_alloc(struct _RTMP_ADAPTER *pAd, uint8_t type_mask)
{
	INT32 ret = 0;
	...
	for (entry_idx = 0; entry_idx < dump_entry_num; entry_idx++) {
		...
		ret = mt7990_rxv_dump_link_list_instl(pAd,
...
static UINT32 mt7990_rxv_dump_buf_clear(struct _RTMP_ADAPTER *pAd)
{
	UINT32 ret = 0;
	...
	DlListForEachSafe(rxv_dump_entry, rxv_dump_entry_tmp,
		...
		DlListForEachSafe(rxv_dump_basic_entry, rxv_dump_basic_entry_tmp,
			...
			DlListForEachSafe(rxv_dump_entry_content, rxv_dump_entry_content_tmp,
				...
				ret = mt7990_rxv_dump_link_list_remv(pAd,
			...
			ret = mt7990_rxv_dump_link_list_remv(pAd, rxv_dump_basic_entry, RXV_DUMP_LIST_TYPE_BASIC_ENTRY);
			if (ret)
				goto error0;
		}
		...
		ret = mt7990_rxv_dump_link_list_remv(pAd, rxv_dump_entry, RXV_DUMP_LIST_TYPE_ENTRY);
		if (ret)
			goto error0;
	}
...
static UINT32 mt7990_rxv_dump_update(struct _RTMP_ADAPTER *pAd, VOID *rxv_pkt, uint8_t rxv_cnt)
{
	UINT32 ret = 0;
	...
	for (rxv_idx = 0; rxv_idx < rxv_cnt; rxv_idx++) {
		...
		mt7990_rxv_entry_hdr_parser(pAd, ptr, &rxv_entry_hdr);
		...
		for (type_idx = 0; type_idx < RXV_CONTENT_NUM; type_idx++) {
			mt7990_rxv_content_len(pAd, BIT(type_idx), 1, &len);
			len_byte = len << 2;
			...
			if (type_mask & BIT(type_idx)) {
				...
				ret = mt7990_rxv_dump_link_list_instl(pAd, rxv_dump_basic_entry_list,
				...
				for (user_idx = 0; user_idx < user_num; user_idx++) {
					...
					/* install basic entry to list */
					ret = mt7990_rxv_dump_link_list_instl(pAd, data_list,
							&rxv_dump_entry_content, RXV_DUMP_LIST_TYPE_CONTENT);
					if (ret) {
						os_free_mem(rxv_dump_entry_content.content);
						rxv_dump_entry_content.content = NULL;
...
static UINT32 mt7990_rxv_dump_show_list(struct _RTMP_ADAPTER *pAd)
{
	DL_LIST *rxv_dump_entry_list = NULL, *rxv_dump_basic_entry_list = NULL, *data_list = NULL;
	RXV_DUMP_ENTRY_CONTENT *rxv_dump_entry_content = NULL, *rxv_dump_entry_content_tmp = NULL;
	RXV_DUMP_BASIC_ENTRY *rxv_dump_basic_entry = NULL, *rxv_dump_basic_entry_tmp = NULL;
...
static UINT32 mt7990_rxv_dump_user_content_compose(struct _RTMP_ADAPTER *pAd, DL_LIST *data_list, uint8_t user_idx,
...
error0:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for data list.\n");
	return 1;

error1:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for user content.\n");
	return 1;

error2:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for buffer of length.\n");
	return 1;
}

static UINT32 mt7990_rxv_dump_type_detail_content_compose(
	struct _RTMP_ADAPTER *pAd,
	uint8_t usr_num,
	DL_LIST *data_list,
	...
	UINT32 *len)
{
	...
	*len += sizeof(usr_content_len);
	...
	for (user_idx = 0; user_idx < usr_cnt; user_idx++) {
		mt7990_rxv_dump_user_content_compose(pAd, data_list, user_idx, ptr, &usr_content_len);
		*len += usr_content_len;
		ptr += usr_content_len;
...
error0:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for type detail content.\n");
	return 1;
...
static UINT32 mt7990_rxv_dump_type_content_compose(
	struct _RTMP_ADAPTER *pAd,
	...
	UINT32 *len)
{
	...
	*len += sizeof(type_detail_content_len);
	...
	mt7990_rxv_dump_type_detail_content_compose(pAd,
...
error0:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for badic entry list.\n");
	return 1;

error1:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for type content.\n");
	return 1;
...
static UINT32 mt7990_rxv_dump_rxv_content_compose(
	struct _RTMP_ADAPTER *pAd,
	uint8_t entry_idx,
	VOID *rxv_content,
	UINT32 *len)
	...
	*len += sizeof(type_cnt);
	...
	DlListForEachSafe(rxv_dump_basic_entry, rxv_dump_basic_entry_tmp,
		rxv_dump_basic_entry_list, RXV_DUMP_BASIC_ENTRY, list) {
			...
			mt7990_rxv_dump_type_content_compose(pAd, rxv_dump_basic_entry_list,
...
error0:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for entry list.\n");
	return 1;

error1:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
		"null pointer for rxv content.\n");
	return 1;
...
static UINT32 mt7990_rxv_dump_show_rpt(struct _RTMP_ADAPTER *pAd)
{
	UINT32 ret = 0;
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
	...
	for (idx = ring_idx - valid_entry_num; idx < ring_idx; idx++) {
		...
		mt7990_rxv_dump_rxv_content_compose(pAd, entry_idx, ptr, &len);
...
static UINT32 mt7990_rxv_data_dump(struct _RTMP_ADAPTER *pAd, VOID *Data, UINT32 rxv_cnt, UINT32 rxv_byte_cnt)
{
	...
	mt7990_rxv_dump_update(pAd, Data, rxv_cnt);

	return 0;
}

static UINT32 mt7990_rxv_packet_parse(struct _RTMP_ADAPTER *pAd, VOID *Data)
{
	uint32_t *pbuf = (uint32_t *)Data, *pbuf2 = NULL;
	...
	mt7990_rxv_pkt_hdr_parser(pAd, pbuf, &rxv_pkt_hdr);

	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_INFO,
		"RxV Report: RxvCnt: %d, ByteCnt: %d\n",
		 rxv_pkt_hdr.rxv_cnt, rxv_pkt_hdr.rx_byte_cnt);

	mt7990_rxv_data_dump(pAd, Data, rxv_pkt_hdr.rxv_cnt, rxv_pkt_hdr.rx_byte_cnt);
...
static VOID mt7990_set_mgmt_pkt_txpwr_prctg(RTMP_ADAPTER *pAd,	struct wifi_dev *wdev, uint8_t prctg)
{
	int8_t  power_dropLevel = 0;


	if (!wdev) {
		MTWF_DBG(pAd, DBG_CAT_HW, CATHW_MAC, DBG_LVL_ERROR, "wdev NULL\n");
		return;
	}

	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_MAC, DBG_LVL_INFO,
			"[TxdPwrOffset]: %d\n", wdev->mgmt_txd_txpwr_offset);
...
static VOID mt7990_rssi_get(RTMP_ADAPTER *pAd, uint16_t Wcid, CHAR *RssiSet)
{
	...
	RssiSet[4] = rssi_rpt.rssi[4];

	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_DEBUG,
		"wcid: %d, rssi: %d, %d, %d, %d, %d\n", Wcid,
		 RssiSet[0], RssiSet[1], RssiSet[2], RssiSet[3], RssiSet[4]);

}

#ifdef CONFIG_WLAN_SERVICE
#ifdef PRE_CAL_MT7990_SUPPORT
VOID MtATE_Dump_Group_PreCal_7990(RTMP_ADAPTER *pAd, UINT8 op)
{
	UINT32 i = 0;
	UINT32 *ptr = NULL;
	UINT32 totalsize;
...
VOID MtATE_Dump_DPD_PreCal_7990(RTMP_ADAPTER *pAd, UINT8 op)
{
...
INT32 mt7990_ate_group_prek(RTMP_ADAPTER *pAd, UINT8 op)
{
	USHORT doCal1 = 0;
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
	struct physical_device *ph_dev = pAd->physical_dev;
	...
	if (op == PREK_GROUP_CLEAN) {
		...
		MtATE_Dump_Group_PreCal_7990(pAd, op);
		...
		doCal1 = doCal1 | (1 << GROUP_PRECAL_INDN_BIT) | (1 << GROUP5G_PRECAL_INDN_BIT) | (1 << GROUP6G_PRECAL_INDN_BIT);
		chip_ops->eewrite(pAd, PRECAL_INDICATION_BYTE, doCal1);
	} else {
		MTWF_DBG(pAd, DBG_CAT_TEST, CATTEST_ATE, DBG_LVL_ERROR,
				"Should not be here !\n");
...
INT32 mt7990_ate_dpd_prek(RTMP_ADAPTER *pAd, UINT8 op)
{
	UINT8                 i = 0;
	USHORT                doCal1 = 0;
	...
	if (op == PREK_DPD_CLEAN) {
		...
		MtATE_Dump_DPD_PreCal_7990(pAd, op);
		...
		for (i = 0; i < (MT7990_PER_CH_A5_BW20_BW160_SIZE); i++) {
			/* set channel command */
			/* per group calibration - set to channel 36, 52, BW20 */
			if (i < MT7990_PER_CH_A5_BW20_SIZE) {
				ch_cfg.Bw = BW_20;
				ch_cfg.CentralChannel = MT7990_PER_CH_A5_BW20[i];
				ch_cfg.ControlChannel = MT7990_PER_CH_A5_BW20[i];
			} else {
				ch_cfg.Bw = BW_160;
				ch_cfg.CentralChannel =
				MT7990_PER_CH_A5_BW160[i - MT7990_PER_CH_A5_BW20_SIZE];
				ch_cfg.ControlChannel =
				MT7990_PER_CH_A5_BW160[i - MT7990_PER_CH_A5_BW20_SIZE];
			}
			if (ph_dev->chipsku == CAL_7990_SKU_255) {
				if (ch_cfg.CentralChannel >= CAL_7990_THRESHOLD_5G_H)
					ch_cfg.BandIdx = 2;
				else
					ch_cfg.BandIdx = 1;
			} else if (ph_dev->chipsku == CAL_7990_SKU_205)
				ch_cfg.BandIdx = 2;
			else
				ch_cfg.BandIdx = 1;
		...
		for (i = 0; i < (MT7990_PER_CH_A6_BW20_BW160_SIZE); i++) {
			/* set channel command*/
			/* per group calibration - set to channel 36, 52, BW20 */
			if (i < MT7990_PER_CH_A6_BW20_SIZE) {
				ch_cfg.Bw = BW_20;
				ch_cfg.CentralChannel = MT7990_PER_CH_A6_BW20[i];
				ch_cfg.ControlChannel = MT7990_PER_CH_A6_BW20[i];
			} else if (i < (MT7990_PER_CH_A6_BW20_SIZE + MT7990_PER_CH_A6_BW160_SIZE)) {
				ch_cfg.Bw = BW_160;
				ch_cfg.CentralChannel =
				MT7990_PER_CH_A6_BW160[i - MT7990_PER_CH_A6_BW20_SIZE];
				ch_cfg.ControlChannel =
				MT7990_PER_CH_A6_BW160[i - MT7990_PER_CH_A6_BW20_SIZE];
			} else {
				ch_cfg.Bw = BW_320;
				ch_cfg.CentralChannel =
				MT7990_PER_CH_A6_BW320[i - MT7990_PER_CH_A6_BW20_SIZE - MT7990_PER_CH_A6_BW160_SIZE];
				ch_cfg.ControlChannel =
				MT7990_PER_CH_A6_BW320[i - MT7990_PER_CH_A6_BW20_SIZE - MT7990_PER_CH_A6_BW160_SIZE];
				ch_cfg.eht_cen_ch =
				MT7990_PER_CH_A6_BW320[i - MT7990_PER_CH_A6_BW20_SIZE - MT7990_PER_CH_A6_BW160_SIZE];
		...
		for (i = 0; i < MT7990_PER_CH_G_BW20_SIZE; i++) {
			/* set channel command */
			/* per group calibration - set to channel 1, 6, 11, BW20 */
			ch_cfg.Bw = BW_20;
			ch_cfg.CentralChannel = MT7990_PER_CH_G_BW20[i];
			ch_cfg.ControlChannel = MT7990_PER_CH_G_BW20[i];
			ch_cfg.ControlChannel2 = 0;
			ch_cfg.BandIdx = 0;
			ch_cfg.bScan = 1;
...
static VOID mt7990_cninfo_get(RTMP_ADAPTER *pAd, uint8_t ucBandIdx, uint16_t *pCnInfo)
{
	uint16_t cninfo;
...
VOID mt7990_update_mib_bucket(RTMP_ADAPTER *pAd)
{
	UCHAR band_idx = 0;
	UCHAR curr_idx = 0;
...
VOID mt7990_ctrl_rxv_group(RTMP_ADAPTER *ad, uint8_t band_idx, uint8_t group, uint8_t enable)
{
	...
	case FMAC_RXV_GROUP5:
		...
		break;
	default:
		MTWF_DBG(ad, DBG_CAT_HW, CATHW_RXPHY, DBG_LVL_ERROR,
...
INT32 mt7990_get_default_bin_image_file(
	RTMP_ADAPTER *ad, RTMP_STRING *path, BOOLEAN fgBinMode)
{
	...
	if (fgBinMode) {
		...
		if ((get_dev_eeprom_binary(ad) != NULL) &&
			...
			ret = snprintf(path, 100, "%s", MT7990_EEPROM_DEFAULT_FILE_PATH);
#else
		if ((get_dev_eeprom_binary(ad) != NULL) &&
			(strlen(get_dev_eeprom_binary(ad)) > 0))
		...
		/* default bin path from l1profile */
		...
		/* default bin path from hard code */
			ret = snprintf(path, 100, "%s", MT7990_EEPROM_DEFAULT_FILE_PATH);
		}
	}
...
INT32 mt7990_get_prek_image_file(RTMP_ADAPTER *ad, RTMP_STRING *path)
{
	INT ret;
...
UINT32 mt7990_get_efuse_free_blk_num(RTMP_ADAPTER *ad, struct _EFUSE_FREE_BLOCK_INFO *pEfuse_info)
{
	UINT32 ret = 0, i = 0;
	struct _EXT_CMD_EFUSE_FREE_BLOCK_T cmd;
	struct _EXT_EVENT_EFUSE_FREE_BLOCK_V2_T *res = NULL;
	...
	os_alloc_mem(ad, (UCHAR **)&res,
		sizeof(struct _EXT_EVENT_EFUSE_FREE_BLOCK_V2_T) * cap->efuse_total_bank_num);

	if  (res) {
		if (MtCmdEfuseFreeBlockCount(ad,
				     (PVOID)&cmd,
				     (PVOID)res) == NDIS_STATUS_SUCCESS) {
			pEfuse_info->bank_count = cap->efuse_total_bank_num;
			/* block0 is d-die efuse */
			ret = res[0].ucFreeBlockNum;
			for (i = 0; i < cap->efuse_total_bank_num; i++) {
				pEfuse_info->blk_info[i].free_block = res[i].ucFreeBlockNum;
				pEfuse_info->blk_info[i].total_block = res[i].ucTotalBlockNum;
				pEfuse_info->blk_info[i].efuse_num = res[i].uceFuseNum;
			}
		}
		os_free_mem(res);
	}
...
VOID mt7990_wps_led_init(RTMP_ADAPTER *pAd)
{
	/*for others init, TBD*/
}

UCHAR mt7990_wps_led_control(RTMP_ADAPTER *pAd, UCHAR flag)
{
	return 0;
}
...
#ifdef WIFI_UNIFIED_COMMAND
static VOID mt7990_update_ampdu_raw_counters(RTMP_ADAPTER *pAd, UCHAR BandIdx)
{
	/* for PER debug */
...
static VOID init_dev_nick_name(RTMP_ADAPTER *ad)
{
	...
	ret = snprintf((RTMP_STRING *) ad->nickname, sizeof(ad->nickname), "mt7990_sta");
...
{
		MTWF_PRINT("================ TxBf profile Data - Subcarrier Idx = %d(0x%03x) =================\n"
			"=============================== Seg0 Angles ==================================\n"
			...
			pfmu_data->field.rSeg0Ang.field.psi64, pfmu_data->field.rSeg0Ang.field.phi54,
			pfmu_data->field.rSeg0Ang.field.psi54, pfmu_data->field.rSeg0Ang.field.phi44,
			pfmu_data->field.rSeg0Ang.field.psi84, pfmu_data->field.rSeg0Ang.field.phi74,
			pfmu_data->field.rSeg0Ang.field.psi74, pfmu_data->field.rSeg0Ang.field.phi64,
	...
	IN UINT8 *pBuf)
{
...
#if (defined(CONFIG_ATE) && defined(CONFIG_WLAN_SERVICE))
	if (ATE_ON(pAd)) {
		he_bw = HE_BW_160;
		MTWF_PRINT("force he_bw = HE_BW_160(%d) in test mode\n", he_bw);
#ifdef DOT11_EHT_BE
		eht_bw = EHT_BW_320;
		MTWF_PRINT("force eht_bw = EHT_BW_320(%d) in test mode\n", eht_bw);
#endif
	}
#endif
	...
	if (tx_nss > 4) {
		txbf_show_pfmu_data_nss4above_seg0(pAd, &pfmu_data, subCarrIdx);
		...
		if (he_bw == HE_BW_160 || he_bw == HE_BW_8080) {
			MTWF_PRINT(
				...
				pfmu_data.field.rSeg1Ang.field.psi64, pfmu_data.field.rSeg1Ang.field.phi54,
				pfmu_data.field.rSeg1Ang.field.psi54, pfmu_data.field.rSeg1Ang.field.phi44,
				pfmu_data.field.rSeg1Ang.field.psi84, pfmu_data.field.rSeg1Ang.field.phi74,
				pfmu_data.field.rSeg1Ang.field.psi74, pfmu_data.field.rSeg1Ang.field.phi64,
		...
		if (eht_bw == EHT_BW_320) {
			MTWF_PRINT(
				...
				pfmu_data.field.rSeg2Ang.field.psi64, pfmu_data.field.rSeg2Ang.field.phi54,
				pfmu_data.field.rSeg2Ang.field.psi54, pfmu_data.field.rSeg2Ang.field.phi44,
				pfmu_data.field.rSeg2Ang.field.psi84, pfmu_data.field.rSeg2Ang.field.phi74,
				pfmu_data.field.rSeg2Ang.field.psi74, pfmu_data.field.rSeg2Ang.field.phi64,
			...
			MTWF_PRINT(
				...
				pfmu_data.field.rSeg3Ang.field.psi64, pfmu_data.field.rSeg3Ang.field.phi54,
				pfmu_data.field.rSeg3Ang.field.psi54, pfmu_data.field.rSeg3Ang.field.phi44,
				pfmu_data.field.rSeg3Ang.field.psi84, pfmu_data.field.rSeg3Ang.field.phi74,
				pfmu_data.field.rSeg3Ang.field.psi74, pfmu_data.field.rSeg3Ang.field.phi64,
	...
	IN  TXBF_STATUS_INFO * pTxBfInfo)
{
	...
	UINT8 tx_path = 0;
	UINT8 max_bfee_ss = MT7990_MAX_BFEE_SS;
...
static VOID mt7990_mcs_nss_cap_init(struct mcs_nss_caps *mcs_nss)
{
	UINT8 txrx = 0;
...
static VOID mt7990_dump_ser_stat(RTMP_ADAPTER *pAd, uint8_t fgDumpAll)
{
...
static VOID mt7990_tx_deley_parm_init(UCHAR tx_delay_mode, struct tx_delay_control *tx_delay_ctl)
{
...
static INT32 set_mumimo_fixed_group_rate(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	AndesSendCmdMsg(pAd, msg);
error:
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_ERROR, "(Ret = %d_\n", Ret);
#endif /* WIFI_UNIFIED_COMMAND */
	return Ret;
}
...
static VOID mt7990_wf_subsys_reset(struct _RTMP_ADAPTER *pAd)
{
	asic_ser_handler(pAd, SER_ACTION_HW_RESET, 0);
}

static VOID mt7990_heart_beat_check(struct _RTMP_ADAPTER *pAd)
{
...
static VOID mt7990_write_tmac_info_fixed_rate(
	RTMP_ADAPTER *pAd,
	struct wifi_dev *wdev,
	UCHAR *tmac_info,
	MAC_TX_INFO *info,
	union _HTTRANSMIT_SETTING *transmit)
{
	...
	if (!info->IsAutoRate) {
		...
		if (info->Type == FC_TYPE_MGMT
				...
				&& transmit->field.MODE == MODE_HE
				&& transmit->field.MCS == MCS_0)
			HAL_TX_DESC_SET_FIXED_RATE_IDX(txd, FR_HE_SPE0x18_MCS0);
		else if (info->Type == FC_TYPE_MGMT
				&& info->SubType == SUBTYPE_BEACON
				&& transmit->field.BW == BW_80)
			HAL_TX_DESC_SET_FIXED_RATE_IDX(txd, FR_OFDM_6M);
		else if ((pAd->CommonCfg.bSeOff != TRUE)
			...
			if (band_idx == BAND0)
				HAL_TX_DESC_SET_FIXED_RATE_IDX(txd, FR_CCK_1M);
			else
...
static VOID mt7990_chipCap_init(
	struct physical_device *ph_dev, RTMP_CHIP_CAP *chip_cap)
{
...
#ifdef DOT11_EHT_BE
	chip_cap->phy_caps |=
		(fPHY_CAP_EHT | fPHY_CAP_BW320 | fPHY_CAP_EHT_DUP);
#endif /* DOT11_EHT_BE */
...
#ifdef TXBF_SUPPORT
	chip_cap->FlgHwTxBfCap = TXBF_HW_CAP | TXBF_HW_2BF | TXBF_HW_3BF;
	chip_cap->pfmu_num_max = 48;
#endif
	...
	/* d-die efuse */
	chip_cap->EFUSE_RESERVED_SIZE = 59;
#endif
	chip_cap->efuse_content_start = 0x0;
	chip_cap->efuse_content_end = 0xdff;
	chip_cap->EEPROM_DEFAULT_BIN = mt7990_get_default_bin_image(ph_dev);
	chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7990_E2PImage_iPAiLNA);
	chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7990_E2PImage_iPAiLNA);
	...
	chip_cap->rom_patch_offset = MT7990_ROM_PATCH_START_ADDRESS;
	...
	chip_cap->wtbl_max_entries = MT7990_MT_WTBL_SIZE;

	chip_cap->drr_max_dw = 34;
	/* WF_DRR_TOP_AC0_STATION_PAUSE00_ADDR ~ WF_DRR_TOP_AC0_STATION_PAUSE31_ADDR,
	WF_DRR_TOP_AC0_STATION_PAUSE_EXT_00_ADDR, WF_DRR_TOP_AC0_STATION_PAUSE_EXT_01_ADDR */
	chip_cap->drr_max_dw_twt = 34;
	/* WF_DRR_TOP_TWT_STA_MAP00_ADDR ~ WF_DRR_TOP_TWT_STA_MAP31_ADDR,
	WF_DRR_TOP_TWT_STA_MAP_EXT_00_ADDR, WF_DRR_TOP_TWT_STA_MAP_EXT_01_ADDR */
	chip_cap->drr_cmd_query = TRUE;
#ifdef SW_CONNECT_SUPPORT
	/* 1502 - 1021 = 481 */
	/* HW Layout : 0, 1, 2, ~ 1021 */
	/* SW DUMMY Layout : (DUMMY) 1022, 1023, 1024 */
	/* SW Layout : 1025 ~ 1502, 2 extra for 2 other band use */
	chip_cap->sw_ucast_max_entries = 481;
	/* chip_cap->ucast_sw.start = 1022; */
	/* chip_cap->ucast_sw.end = 1502; */
	/* use same boundary, and let mt7990_mactbl_uwtbl_adjust() to adjust again */
	chip_cap->hw_sw_max_entries = chip_cap->wtbl_max_entries;
#endif /* SW_CONNECT_SUPPORT */
	chip_cap->wtbl_no_matched = 0xfff; /* MT7990 wcid use 12 bits */
	...
	chip_cap->single_sku_fill_tbl_length = MT7990_SINGLE_SKU_FILL_TABLE_LENGTH;
	...
	chip_cap->spe_map_list.spe_map = mt7990_spe_map;
	chip_cap->spe_map_list.size = ARRAY_SIZE(mt7990_spe_map);
	...
	chip_cap->prek_ee_info.cal_result_size_6g = 125 * 1024;
	chip_cap->prek_ee_info.cal_result_size_5g_2die = 44 * 1024;
	chip_cap->prek_ee_info.cal_result_size_6g_2die = 100 * 1024;
	chip_cap->prek_ee_info.cal_result_size_adcdcoc_2g = 4 * 4;
	chip_cap->prek_ee_info.cal_result_size_adcdcoc_5g = 4 * 4;
	...
	chip_cap->prek_ee_info.pre_cal_total_size_2adie =
	chip_cap->prek_ee_info.cal_result_size + chip_cap->prek_ee_info.cal_result_size_adcdcoc_2g +
	chip_cap->prek_ee_info.cal_result_size_5g_2die + chip_cap->prek_ee_info.cal_result_size_6g_2die +
	chip_cap->prek_ee_info.cal_result_size_adcdcoc_5g + chip_cap->prek_ee_info.cal_result_size_adcdcoc_6g;

	/* DPD & Flatness item */

	chip_cap->prek_ee_info.per_legaycy_ch_cal_size = 4 * 1024;
	chip_cap->prek_ee_info.per_mem_ch_cal_size = 13 * 1024;
	chip_cap->prek_ee_info.per_ch_cal_OTFG0_size = 2 * 1024;

	chip_cap->prek_ee_info.per_ch_6g_num = MT7990_PER_CH_A6_BW20_BW160_SIZE;
	chip_cap->prek_ee_info.per_ch_5g_num = MT7990_PER_CH_A5_BW20_BW160_SIZE;
	chip_cap->prek_ee_info.per_ch_2g_num = MT7990_PER_CH_G_BW20_SIZE;
	...
	(chip_cap->prek_ee_info.per_legaycy_ch_cal_size + chip_cap->prek_ee_info.per_ch_cal_OTFG0_size)  * MT7990_PER_CH_A6_BW20_SIZE;

	chip_cap->prek_ee_info.dpd_cal_6g_mem_size =
	(chip_cap->prek_ee_info.per_mem_ch_cal_size + chip_cap->prek_ee_info.per_ch_cal_OTFG0_size) * (MT7990_PER_CH_A6_BW160_SIZE + MT7990_PER_CH_A6_BW320_SIZE);
	...
	(chip_cap->prek_ee_info.per_legaycy_ch_cal_size + chip_cap->prek_ee_info.per_ch_cal_OTFG0_size) * MT7990_PER_CH_A5_BW20_SIZE;

	chip_cap->prek_ee_info.dpd_cal_5g_mem_size =
	(chip_cap->prek_ee_info.per_mem_ch_cal_size + chip_cap->prek_ee_info.per_ch_cal_OTFG0_size) * MT7990_PER_CH_A5_BW160_SIZE;
...
#endif /* OCE_SUPPORT */
	chip_cap->bus_info = &mt7990_bus_info;
	chip_cap->sizeof_rxd_grp0 = sizeof(struct bmac_rxd_grp_0);
	chip_cap->fid_shift = 15;
	chip_cap->fid_invalid_id = UMAC_FID_1FFF_FAULT;
	chip_cap->hw_band_num = CFG_WIFI_MT7990_BAND_NUM;
	chip_cap->rxgaincal_ofst = RX_GAIN_CAL_EEPROM_OFST;
#ifdef TX_POWER_CONTROL_SUPPORT_V2
	chip_cap->tx_power_boost_ver = 2;
#endif
	chip_cap->step_one_timeout = RRO_STEP_ONE_TIMEOUT_V1;
	chip_cap->flush_all_timeout = RRO_FLUSH_ALL_TIMEOUT_V1;
#ifdef DOT11V_MBSSID_SUPPORT
	chip_cap->transmitted_bss_num = MT7990_MAX_TRANSMITTED_NUM;
	chip_cap->transmitted_bss_bitmap = MT7990_TRANSMITTED_BSS_BITMAP;
#endif /* DOT11V_MBSSID_SUPPORT */
	chip_cap->rss_map.map0 = RRO_RSS_MAP_1RING;
	chip_cap->rss_map.map1 = RRO_RSS_MAP_1RING;
	/* use 256 for per second probe rsp drop */
	chip_cap->ProbeRspMaxNum = 256;
	chip_cap->WtblDupNum = 80;
}

static VOID mt7990_chipCap_post_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_CAP *chip_cap)
{
 ...
 */
static VOID mt7990_txd_post_process(
	struct _RTMP_ADAPTER *pAd,
...
static UINT32 mt7990_get_wf_path_comb(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	UINT8 dbdc_mode_en,
	UINT8 *path,
...
#ifdef DOT11_EHT_BE
#define MLO_BA_WSIZE_THRESHOLD 15300 /* 13000 / 0.85 */
static BOOLEAN check_mlo_ba_chip_boundary(struct _MAC_TABLE_ENTRY *pEntry)
{
	BOOLEAN ret = FALSE;
	UINT8 link;
	UINT8 mcs, bw, nss;
	UINT16 max_ba_wsize_scene_mlo;
	ULONG phy_rate, total_phy_rate = 0;
	...
	if (!pEntry || !pEntry->wdev) {
		MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_ERROR,
			"(ERROR):entry or wdev is NULL\n");
		return ret;
	}

	pAd = pEntry->wdev->sys_handle;
	cap = hc_get_chip_cap(pAd->hdev_ctrl);
	max_ba_wsize_scene_mlo = cap->max_ba_wsize_scene_mlo;

	/* 0 means no boundary */
	if (!max_ba_wsize_scene_mlo) {
		MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_INFO,
			"max_ba_wsize_scene_mlo: %d\n",	max_ba_wsize_scene_mlo);
		return ret;
	}
	...
	for (link = 0; link < MLD_LINK_MAX; link++) {
		link_entry = (struct _MAC_TABLE_ENTRY *)mld_entry->link_entry[link];
		if (!link_entry || !link_entry->mlo.mlo_en)
			continue;

		nss = (link_entry->MaxHTPhyMode.field.MCS >> 4) + 1;
		mcs = link_entry->MaxHTPhyMode.field.MCS & 0xf;
		bw  = link_entry->MaxHTPhyMode.field.BW;

		MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_INFO,
			"link:%d, nss:%d, mcs:%d, bw:%d, vendor(%d)\n",
			link, nss, mcs, bw, link_entry->vendor_ie.is_mtk);

		get_rate_eht(mcs, bw, nss, 0, &phy_rate);

		total_phy_rate += phy_rate;
	}
	mt_rcu_read_unlock();
	...
	if (total_phy_rate > MLO_BA_WSIZE_THRESHOLD)
		ret = TRUE;
...
#ifdef DOT11_EHT_BE
static VOID limit_bw_in_320_1(UCHAR prim_ch, UCHAR *bw, UCHAR *ext_ch,
	UCHAR *cen_ch)
{
	INT idx = 0;
	UINT ch_layout_size = 0;
	struct eht_ch_layout *ch_320M =
		get_eht_ch_array(BW_320, CMD_CH_BAND_6G, &ch_layout_size);
	UCHAR adjusted_ext_cha = EXTCHA_NONE;

	if (!ch_320M) {
		MTWF_DBG(NULL, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
			"get_eht_ch_array failed!\n");
		return;
	}

	while (idx < ch_layout_size &&
			ch_320M[idx].ch_up_bnd != 0) {

		if (idx % 2 == 1) { /* skip 320-2 group */
			idx++;
			continue;
		}
		...
		if (prim_ch >= ch_320M[idx].ch_low_bnd &&
			 ...
			 * central ch > primary channel
			 */
			if (prim_ch > ch_320M[idx].cent_freq_idx)
				adjusted_ext_cha = EXTCHA_BELOW;
			else
				adjusted_ext_cha = EXTCHA_ABOVE;

			*cen_ch = ch_320M[idx].cent_freq_idx;
	...
	if (adjusted_ext_cha == EXTCHA_NONE) { /* not hit any 320-1 group, lower bw */
		*bw = BW_160;
	} else
		*ext_ch = adjusted_ext_cha;
}
#endif

static VOID mt7990_extra_action(
	...
	ULONG *data_len)
{
	UINT16 hw_ver = PD_GET_HW_VER(ad->physical_dev);
...
#ifdef DOT11_EHT_BE
	if (action & CHIP_EXTRA_ACTION_TX_ENABLE_AGG_CAP) {
		UINT16 ba_wsize;
		struct _RTMP_CHIP_CAP *cap = hc_get_chip_cap(ad->hdev_ctrl);

		if (peer_mac)
			entry = MacTableLookup(ad, peer_mac);
		if (entry) {
			if (entry->vendor_ie.is_mtk && check_mlo_ba_chip_boundary(entry)) {
				if (!data) {
				...
				ba_wsize = *((UINT16 *)data);
				if (ba_wsize > cap->max_ba_wsize_scene_mlo) {
					struct _STA_REC_CTRL_T sta_rec_ctrl = {0};

					sta_rec_ctrl.WlanIdx = entry->wcid;
					mtf_asic_tx_cap_update(ad, &sta_rec_ctrl, TRUE);
				}
			}
		} else {
			MTWF_DBG(ad, DBG_CAT_HW, CATHW_PHY, DBG_LVL_WARN,
	...
	if (action & CHIP_EXTRA_ACTION_RX_BA_WSIZE_MLO) {
		UINT16 max_ba_wsize_scene_mlo;
		struct _RTMP_CHIP_CAP *cap = hc_get_chip_cap(ad->hdev_ctrl);
		...
		if (entry) {
			if (!entry->vendor_ie.is_mtk && check_mlo_ba_chip_boundary(entry)) {
				...
				if (data) {
					max_ba_wsize_scene_mlo = min(*((UINT16 *)data), max_ba_wsize_scene_mlo);
					NdisMoveMemory(data, &max_ba_wsize_scene_mlo, sizeof(max_ba_wsize_scene_mlo));
					*data_len = (ULONG)sizeof(max_ba_wsize_scene_mlo);
				} else {
					MTWF_DBG(ad, DBG_CAT_HW, CATHW_PHY, DBG_LVL_WARN,
						"data is NULL!");
				}
	...
	if (action & CHIP_EXTRA_ACTION_ADDBA_SSN) {
		if (data) {
			if (hw_ver == 0x8A00)
				*data = 1;
		}
...
#ifdef DOT11_EHT_BE
	if (action & CHIP_EXTRA_ACTION_PROFILE_CORRECT) {
		if (hw_ver == 0x8A00) {
			if (PD_CEHCK_MLO_V1_DISABLE(ad->physical_dev))
				PD_MTK_MLO_V1_1_ENABLE(ad->physical_dev);
		} else
			PD_MTK_MLO_V1_DISABLE(ad->physical_dev);
	}
#endif /* DOT11_EHT_BE */

	if (action & CHIP_EXTRA_ACTION_ADDBA_WAIT_ADD) {
		struct _RTMP_CHIP_CAP *cap = hc_get_chip_cap(ad->hdev_ctrl);
		struct BA_REC_ENTRY *pBAEntry = (struct BA_REC_ENTRY *)data;

		MTWF_DBG(ad, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_INFO,
			"EXTRA_ACTION_ADDBA_WAIT_ADD (Wcid/TID/SeId = %d/%d/%d)\n",
			pBAEntry->pEntry->wcid, pBAEntry->TID, pBAEntry->Session_id);
		if ((cap->hw_rro_en && (cap->asic_caps & fASIC_CAP_HW_RRO))) {
			pBAEntry->WaitWM = 1;
			/* Wait delete finish */
	...
	if (action & CHIP_EXTRA_ACTION_ADDBA_WAIT_DELETE) {
		struct _RTMP_CHIP_CAP *cap = hc_get_chip_cap(ad->hdev_ctrl);
		struct BA_REC_ENTRY *pBAEntry = (struct BA_REC_ENTRY *)data;

		MTWF_DBG(ad, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_INFO,
			"EXTRA_ACTION_ADDBA_WAIT_DELETE (Wcid/TID/SeId = %d/%d/%d)\n",
			pBAEntry->pEntry->wcid, pBAEntry->TID, pBAEntry->Session_id);
		if ((cap->hw_rro_en && (cap->asic_caps & fASIC_CAP_HW_RRO))) {
			pBAEntry->WaitWM = 1;
			/* Wait event back, then remove ba_entry*/
			pBAEntry->Postpone_Action = DELBA_POSTPONE;
		}
		return;
	}
	if (action & CHIP_EXTRA_ACTION_ADDBA_WAIT_INIT) {
		struct _RTMP_CHIP_CAP *cap = hc_get_chip_cap(ad->hdev_ctrl);
		struct BA_REC_ENTRY *pBAEntry = (struct BA_REC_ENTRY *)data;

		MTWF_DBG(ad, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_INFO,
			"EXTRA_ACTION_ADDBA_WAIT_INIT (Wcid/TID/SeId = %d/%d/%d)\n",
			pBAEntry->pEntry->wcid, pBAEntry->TID, pBAEntry->Session_id);
		if ((cap->hw_rro_en && (cap->asic_caps & fASIC_CAP_HW_RRO))) {
			pBAEntry->WaitWM = 1;
			/* First ADDBA receive, send event immediately */
			pBAEntry->Postpone_Action = 0;
		}
		return;
	}
	...
	if (action & CHIP_EXTRA_ACTION_RX_RESTORE_OLDPKT) {
		struct BA_REC_ENTRY *ba_entry = (struct BA_REC_ENTRY *)data;
		struct _RX_BLK *rx_blk = (struct _RX_BLK *)data_len;
		UINT16 seq = rx_blk->SN;

		if (seq == ba_entry->LastIndSeq) {
			if (RX_BLK_TEST_ERR_FLAG(rx_blk, fRX_ERR_IP_FRAG_OLD_PKT) && !rx_blk->AmsduState) {
				ba_entry->drop_dup_pkts++;
				RELEASE_NDIS_PACKET(ad, rx_blk->pRxPacket, NDIS_STATUS_FAILURE);
				rx_blk->pRxPacket = NULL;
				return;
			}
		} else if (SEQ_SMALLER(seq, ba_entry->LastIndSeq, MAXSEQ)) {
			if (RX_BLK_TEST_ERR_FLAG(rx_blk, fRX_ERR_IP_FRAG_OLD_PKT) && (ba_entry->PreviousSN & BIT(seq % OLDPKT_CHECK_CNT))) {
				ba_entry->drop_old_pkts++;
				RELEASE_NDIS_PACKET(ad, rx_blk->pRxPacket, NDIS_STATUS_FAILURE);
				rx_blk->pRxPacket = NULL;
				return;
			}
		} else if (!(SEQ_STEPONE(seq, ba_entry->LastIndSeq, MAXSEQ))) {
			ba_entry->LastIndSeq = SEQ_INC(ba_entry->LastIndSeq, 1, MAXSEQ);
			while (seq != ba_entry->LastIndSeq) {
				ba_entry->PreviousSN  &= ~BIT(ba_entry->LastIndSeq % OLDPKT_CHECK_CNT);
				ba_entry->LastIndSeq = SEQ_INC(ba_entry->LastIndSeq, 1, MAXSEQ);
			}
		} else
	...
	if (action & CHIP_EXTRA_ACTION_IDLE_DETECT) { /* Send BAR */
		if (peer_mac)
			entry = MacTableLookup(ad, peer_mac);
		if (entry)
			ba_refresh_bar(ad, entry);
		else {
			MTWF_DBG(ad, DBG_CAT_HW, CATHW_PHY, DBG_LVL_WARN,
				"cannot find this entry("MACSTR").\n", MAC2STR(peer_mac));
		}
	...
	if (data && (action & CHIP_EXTRA_ACTION_SW_PN)) {
		struct _TX_BLK *tx_blk = (struct _TX_BLK *)data;
		...
		if (entry && !IS_CIPHER_NONE(tx_blk->CipherAlg)) {
			TX_BLK_SET_FLAG(tx_blk, fTX_bSwPN);
			inc_iv_byte(entry->sw_pn, LEN_PN, 1);
			os_move_mem(tx_blk->sw_pn, entry->sw_pn, LEN_PN);
			hex_dump_with_cat_and_lvl("SW PN", entry->sw_pn,
				6, DBG_CAT_TX, CATTX_FRAG_TX, DBG_LVL_INFO);
		}
		return;
	}

#ifdef DOT11_EHT_BE
	if (action & CHIP_EXTRA_ACTION_EXTCHA_ADJUST) {
		if (data) {
			struct ch_info *ch_info = (struct ch_info *)data;

			MTWF_DBG(ad, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO,
				"data=%d-%d-%d-%d.\n", ch_info->prim_ch, ch_info->bw, ch_info->ext_cha, ch_info->cen_ch);
			limit_bw_in_320_1(ch_info->prim_ch, &ch_info->bw, &ch_info->ext_cha,
				&ch_info->cen_ch);
			MTWF_DBG(ad, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO,
				"data=%d-%d-%d-%d.\n", ch_info->prim_ch, ch_info->bw, ch_info->ext_cha, ch_info->cen_ch);
		}
...
static VOID mt7990_set_rro_timeout(
	struct _RTMP_ADAPTER *ad)
{
	UINT16 hw_ver = PD_GET_HW_VER(ad->physical_dev);
	...
	if ((hw_ver > 0x8A00) && !PD_GET_RRO_TIMEOUT_PROFILE_SET(ad->physical_dev)) {
...
#ifdef DOT11_EHT_BE
static UINT8 mt7990_determine_mtk_mlo_type(struct _RTMP_ADAPTER *ad, struct wifi_dev *wdev)
{
	UINT16 hw_ver = PD_GET_HW_VER(ad->physical_dev);
	...
	if (PD_CEHCK_MLO_V1_ENABLE(ad->physical_dev))
		return (MEDIATEK_TLV1_TYPE4_MLO_V1 | MEDIATEK_TLV1_TYPE4_MLO_FORCE);
	else
		return MEDIATEK_TLV1_TYPE4_MLO_V1_1;
}

static BOOLEAN mt7990_determine_mtk_mlo_allow(struct _RTMP_ADAPTER *ad, struct _vendor_ie_cap *vendor_ie)
{
	struct physical_device *ph_dev;
	...
	if (PD_CEHCK_MLO_V1_DISABLE(ph_dev) ||
		(PD_CEHCK_MLO_V1_1_ENABLE(ph_dev) &&
			vendor_ie->mtk_mlo_enable != (MEDIATEK_TLV1_TYPE4_MLO_V1 | MEDIATEK_TLV1_TYPE4_MLO_FORCE)) ||
		(PD_CEHCK_MLO_V1_ENABLE(ph_dev) &&
			((vendor_ie->mtk_mlo_enable & MEDIATEK_TLV1_TYPE4_MLO_V1) ||
			(vendor_ie->mtk_mlo_enable & MEDIATEK_TLV1_TYPE4_MLO_V2))))
			return TRUE;
	else
		return FALSE;
}
...
static BOOLEAN mt7990_set_spe_fr_table(
	struct _RTMP_ADAPTER *ad,
	UINT8 band_idx,
	UINT8 rate_idx,
	VOID *handle)
{
	...
	case BAND1: /* 5G */
		...
		fr_tab_set->u2FixedRate = 0x004B; /* OFDM 6M */
		break;
	case BAND2: /* 6G */
		fr_tab_set->ucFrSpeIdx = BAND2_SPE_IDX;
		fr_tab_set->u2FixedRate = 0x004B; /* OFDM 6M, To align jedi setting */
		break;
	case BAND0: /* 2G */
	default:
		fr_tab_set->ucFrSpeIdx = BAND0_SPE_IDX;
		fr_tab_set->u2FixedRate = 0x004B; /*  OFDM 6M, for better performance */
		break;
	}
...
UINT16 mt7990_get_uwtbl_sn(struct _RTMP_ADAPTER *pAd, UINT16 wcid, UCHAR tid)
{
	UINT16 u2CmdSN = 0;
	UINT_16 u2CmdTidSn[8] = {0};
	UniCmdPerStaGetSN(pAd, wcid, u2CmdTidSn);
	u2CmdSN = u2CmdTidSn[tid];
	return u2CmdSN;
}


/* Only need to do once */
INT32 mt7990_mactbl_uwtbl_adjust(struct _RTMP_ADAPTER *ad)
{
	struct mtk_mac_dev *mac_dev = hc_get_mac_dev(ad);
	struct _RTMP_CHIP_CAP *chip_cap = PD_GET_CHIP_CAP_PTR(ad->physical_dev);
	struct physical_device *ph_dev = (struct physical_device *)ad->physical_dev;
	int ret = 0;
	u16 max_wtbl = 0, sku_max_sta = 0, ucast_wtbl = 0, sku_max_grp = 0;
	...
	sku = PD_GET_HW_WTBL_SUPPORT(ad->physical_dev);
	...
	case 0x4:
		sku_max_sta = 1024;
		/* remain grp 63  that wtbl_max_entries is 1088, range : 0 ~ 1087 */
		sku_max_grp = (chip_cap->wtbl_max_entries - sku_max_sta - 1);
		break;
	case 0x3:
		sku_max_sta = 768;
		/* keep grp 64 as hwifi original */
		sku_max_grp = (hw_group_high - hw_group_low + 1);
		break;
	case 0x0:
		fallthrough;
	case 0x2:
	...
	MTWF_DBG(ad, DBG_CAT_INIT, CATINTF_UP, DBG_LVL_NOTICE,
		"sku_max_sta=%u, sku_max_grp=%u, hw_group_low=%u, hw_group_high=%u\n", sku_max_sta, sku_max_grp, hw_group_low, hw_group_high);

	if (sku_max_sta)
		ret = mac_dev->ops->set_max_uwtbl_sta_num(&mac_dev->hw, sku_max_sta, sku_max_grp);
#ifdef MEMORY_SLIM
	sku_max_grp = 3 * MAX_BEACON_NUM;
	if (sku_max_sta)
		sku_max_sta = sku_max_sta / 2;
	else
		sku_max_sta = 512;
	...
	if (hc_is_sw_sta_enable(ad)) {
		...
		/* as 1024 as hw_uwtbl_high example : Dummy 1022/1023/1024 is also as S/W */
		 ...
		 */
		/* ex : max_wtbl(1088, include wcid 0) + (481 - 3 dummy wcid) = 1566 = WTBL_MAX_NUM() */
		hc_set_chip_hw_sw_wtbl_num(ad->hdev_ctrl, max_wtbl, (sw_ucast_max - PD_GET_BAND_NUM(ad->physical_dev)));
		/* ex: (1 (wcid 0)) + 1024 + (481 -3) = 1503  = GET_MAX_UCAST_NUM() */
	...
	if (orig_max_wtbl != WTBL_MAX_NUM(ad)) {
		/* re-size from ex:
		*	1). FULL SW Case : 1088 to 1566 for H/W + S/W
		*	2). sku 512 / 7618 / 1024 adjust
		*/
...
static VOID mt7990_dump_rmac_info_normal(
...
*/
static INT32 mt7990_trans_rxd_into_rxblk(
	struct _RTMP_ADAPTER *pAd, struct _RX_BLK *rx_blk, PNDIS_PACKET rx_pkt)
{
	...
	if (pAd->veri_ctrl.dump_rx_debug)
		mt7990_dump_rmac_info_normal(pAd, rmac_info);
#endif
...
#if defined(WIFI_DIAG) && defined(MT7915) && defined(BELLWETHER)
	...
	if (((HAL_RX_STATUS_GET_GROUP_VLD(rxd_grp0)
		...
		if (rx_blk->band >= CFG_WIFI_RAM_BAND_NUM) {
			MTWF_DBG(pAd, DBG_CAT_HW, CATHW_MAC, DBG_LVL_ERROR,
				"Invalid band(%d)!\n", rx_blk->band);
			err = 1;
			goto err_out;
...
static struct _RTMP_CHIP_OP mt7990_chip_op = { 0 };

static VOID mt7990_chipOp_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_OP *chip_op)
{
	...
	chip_op->GetBandSelectFromEEPROM = mt7990_get_band_select_from_eeprom;
	...
	chip_op->get_sku_tbl_idx = mt7990_get_sku_tbl_idx;
	chip_op->check_RF_lock_down = mt7990_check_RF_lock_down;
	chip_op->Config_Effuse_Country = mt7990_Config_Effuse_Country;
...
#ifdef TXBF_SUPPORT
	chip_op->iBFPhaseComp			= iBFPhaseComp;
	chip_op->iBFPhaseCalInit		= iBFPhaseCalInit;
	chip_op->iBFPhaseFreeMem		= iBFPhaseFreeMem;
	chip_op->iBFPhaseCalE2PUpdate	= iBFPhaseCalE2PUpdate;
	chip_op->iBFPhaseCalReport		= iBFPhaseCalReport;
	...
	chip_op->get_wf_path_comb = mt7990_get_wf_path_comb;
	chip_op->read_chl_pwr = NULL;
	chip_op->get_rx_stat_all = mt7990_get_rx_stat_all;
	chip_op->get_rx_stat = mt7990_get_rx_stat;
#ifdef CONFIG_WLAN_SERVICE
	chip_op->get_chip_capability = mt7990_get_chip_capability;
#endif
	chip_op->rxv_get_byte_cnt = mt7990_rxv_get_byte_cnt;
	chip_op->rxv_get_content = mt7990_rxv_get_content;
	chip_op->rxv_packet_parse = mt7990_rxv_packet_parse;
	chip_op->rxv_entry_parse = mt7990_rxv_entry_parse;
	chip_op->rxv_info_show = mt7990_rxv_info_show;
	chip_op->rxv_raw_data_show = mt7990_rxv_raw_data_show;
	chip_op->rxv_stat_reset = mt7990_rxv_stat_reset;
	chip_op->rxv_cap_init = mt7990_rxv_cap_init;
	chip_op->rxv_dump_start = mt7990_rxv_dump_start;
	chip_op->rxv_dump_stop = mt7990_rxv_dump_stop;
	chip_op->rxv_dump_buf_alloc = mt7990_rxv_dump_buf_alloc;
	chip_op->rxv_dump_buf_clear = mt7990_rxv_dump_buf_clear;
	chip_op->rxv_dump_show_list = mt7990_rxv_dump_show_list;
	chip_op->rxv_dump_show_rpt = mt7990_rxv_dump_show_rpt;
	chip_op->rxv_dump_rxv_content_compose = mt7990_rxv_dump_rxv_content_compose;
	chip_op->rxv_content_len = mt7990_rxv_content_len;
#ifdef DOT11_HE_AX
#ifdef WIFI_TWT_SUPPORT
...
#endif /* WIFI_TWT_SUPPORT */
#endif /* DOT11_HE_AX */
	chip_op->get_tid_sn = mt7990_get_uwtbl_sn;
	/* per chip sku adjust */
	chip_op->mactbl_wtbl_adjust = mt7990_mactbl_uwtbl_adjust;
...
#ifdef CONFIG_WLAN_SERVICE
#ifdef PRE_CAL_MT7990_SUPPORT
	chip_op->ate_group_prek = mt7990_ate_group_prek;
	chip_op->ate_dpd_prek = mt7990_ate_dpd_prek;
	chip_op->ChipCheckPrek = mt7990_apply_dpd_flatness_data;
#endif
#endif


#ifdef CONFIG_TX_DELAY
	chip_op->tx_deley_parm_init = mt7990_tx_deley_parm_init;
#endif
...
#endif
#ifdef ERR_RECOVERY
	chip_op->dump_ser_stat = mt7990_dump_ser_stat;
#endif
#ifdef CFG_SUPPORT_FALCON_MURU
	...
	chip_op->rssi_get = mt7990_rssi_get;
	chip_op->ra_init = mt7990_ra_init;
	chip_op->cninfo_get = mt7990_cninfo_get;
	chip_op->txpower_show_info = mtf_txpower_show_info;
	chip_op->update_mib_bucket = mt7990_update_mib_bucket;
	chip_op->ctrl_rxv_group = mt7990_ctrl_rxv_group;
	chip_op->get_bin_image_file = mt7990_get_default_bin_image_file;
#if defined(PRE_CAL_TRX_SET1_SUPPORT) || defined(PRE_CAL_TRX_SET2_SUPPORT) || defined(RLM_CAL_CACHE_SUPPORT)
	chip_op->get_prek_image_file = mt7990_get_prek_image_file;
#endif
	chip_op->set_mgmt_pkt_txpwr_prctg = mt7990_set_mgmt_pkt_txpwr_prctg;
#ifdef RTMP_EFUSE_SUPPORT
	chip_op->get_efuse_free_blk_bnum_v2 = mt7990_get_efuse_free_blk_num;
#endif
#ifdef LED_CONTROL_SUPPORT
	chip_op->wps_led_init = mt7990_wps_led_init;
	chip_op->wps_led_control = mt7990_wps_led_control;
#endif /*LED_CONTROL_SUPPORT*/
#ifdef WIFI_UNIFIED_COMMAND
	chip_op->update_ampdu_raw_counters = mt7990_update_ampdu_raw_counters;
#endif
	chip_op->init_hw_ring_setting = hwifi_init_hw_ring_setting;
	chip_op->get_sku_decision = mt7990_get_sku_decision;
	chip_op->chip_extra_action = mt7990_extra_action;
	chip_op->set_rro_timeout = mt7990_set_rro_timeout;
	chip_op->set_rro_rss_map = NULL;
	chip_op->set_spe_fr_table = mt7990_set_spe_fr_table;
#ifdef DOT11_EHT_BE
	chip_op->determine_mlo_type = mt7990_determine_mtk_mlo_type;
	chip_op->determine_mlo_allow = mt7990_determine_mtk_mlo_allow;
#else
	chip_op->determine_mlo_type = NULL;
	chip_op->determine_mlo_allow = NULL;
#endif /* DOT11_EHT_BE */
...
static VOID mt7990_archOp_init(RTMP_ADAPTER *ad, RTMP_ARCH_OP *arch_ops)
{
	...
	arch_ops->trans_rxd_into_rxblk = mt7990_trans_rxd_into_rxblk;
	...
	arch_ops->write_tmac_info_fixed_rate = mt7990_write_tmac_info_fixed_rate;
#ifdef WF_RESET_SUPPORT
	arch_ops->wf_subsys_reset = mt7990_wf_subsys_reset;
	arch_ops->heart_beat_check = mt7990_heart_beat_check;
#endif
...
#endif
	arch_ops->arch_get_bcn_tx_cnt = mt7990_get_mib_bcn_tx_cnt;
#ifdef AIR_MONITOR
...
#endif
	arch_ops->txd_post_process = mt7990_txd_post_process;
#ifdef DOT11_EHT_BE
...
static VOID mt7990_chipOp_post_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_OP *chip_op)
{
}

static VOID mt7990_hif_ctrl_init(struct _RTMP_ADAPTER *pAd)
{
}

VOID mt7990_init(RTMP_ADAPTER *pAd)
{
	...
	MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_DEBUG, "-->\n");
	mt7990_mcs_nss_cap_init(MCS_NSS_CAP(pAd));
	mt7990_chipOp_init(pAd, &mt7990_chip_op);
	hc_register_chip_ops(ctrl, &mt7990_chip_op);
	mt7990_archOp_init(pAd, arch_ops);
	mt7990_chip_dbg_init(chip_dbg);
	mt7990_hif_ctrl_init(pAd);
	mt_phy_probe(pAd);
	mt7990_chipCap_post_init(pAd, pChipCap);
	mt7990_chipOp_post_init(pAd, chip_ops);
	RTMP_DRS_ALG_INIT(pAd, RATE_ALG_AGBS);

	sku = mt7990_get_sku_decision(pAd);
	if ((sku == MT7990_ADIE_577) || (sku == MT7990_ADIE_507))
...
void mt7990_init_default(void *ph_dev_obj)
{
	...
	MTWF_PRINT("%s()-->\n", __func__);
	mt7990_chipCap_init(ph_dev, &ph_dev->chip_cap);
