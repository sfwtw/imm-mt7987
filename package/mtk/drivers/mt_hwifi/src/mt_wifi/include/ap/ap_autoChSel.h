...
#define PERIODIC_ACS_CH_CHK_TIME 0 /* seconds */
#define PERIODIC_ACS_CH_UTIL_RATIO_THR 0
#define PERIODIC_ACS_CH_STA_NUM_THR 1
...
BOOLEAN mtk_cfg80211_auto_ch_sel(
	PRTMP_ADAPTER pAd,
...
INT ACS_Restore_During_Partial_Scan(
	IN PRTMP_ADAPTER pAd,
	IN struct wifi_dev *pwdev);
