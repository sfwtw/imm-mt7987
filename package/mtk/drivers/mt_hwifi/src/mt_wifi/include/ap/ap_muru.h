...
typedef enum _MURU_QOS_CMD_T {
	...
	QOS_CMD_FIXED_TONE = 11,
	QOS_CMD_UL = 12,
	QOS_CMD_MULTIAC_DL = 13,
	QOS_CMD_FORCE_AC = 14,
	QOS_CMD_FORCE_RU = 15,
	QOS_CMD_USER_DEFINED_DROP_TH = 16,
	QOS_CMD_USER_DEVINED_IDX = 17,
	QOS_CMD_FORCE_PROT = 18,
	QOS_CMD_FORCE_LOW_MCS_SU = 19,
	QOS_CMD_PARAM_SETTING_BY_IE = 20,
	QOS_CMD_PARAM_DELETE_BY_IE = 21
} MURU_QOS_CMD;
...
#define MURU_FIXED_CMM_AC               BIT(3)
#define MURU_FIXED_CMM_SPE_IDX          BIT(4)
#define MURU_FIXED_CMM_PROC_TYPE        BIT(5)
#define MURU_FIXED_CMM_MLO_CTRL         BIT(6)
#define MURU_FIXED_CMM_PDA_POL          BIT(7)
...
#define MURU_FIXED_AGC_POL              BIT(11)
#define MURU_FIXED_PRMBL_PUNC           BIT(12)
...
#define MURU_FIXED_UL_AGC_POL			BIT(10)
...
INT mtk_cfg80211_Set_MuOfdma_Dl_Enable(RTMP_ADAPTER *pAd, UINT_8 enable);
INT mtk_cfg80211_Set_MuOfdma_Ul_Enable(RTMP_ADAPTER *pAd, UINT_8 enable);
INT mtk_cfg80211_Set_MuMimo_Dl_Enable(RTMP_ADAPTER *pAd, UINT_8 enable);
INT mtk_cfg80211_Set_MuMimo_Ul_Enable(RTMP_ADAPTER *pAd, UINT_8 enable);
#endif /*RT_CFG80211_SUPPORT*/
INT set_muru_debug_flow_info(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
INT set_muru_mdvt_flow_info(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
INT set_muru_mdvt_param_info(PCHAR pch, RTMP_STRING *arg, UINT_16 *pu2Item, UINT_32 u4Val[], UINT_8 u1ValSize);
...
VOID muru_show_group_tbl_entry(struct cmd_msg *msg, char *rsp_payload, UINT16 rsp_payload_len);
VOID muru_get_ul_tx_cnt_handler(struct cmd_msg *msg, char *rsp_payload, UINT16 rsp_payload_len);
VOID muru_get_txc_tx_stats_handler(struct cmd_msg *msg, char *rsp_payload, UINT16 rsp_payload_len);
VOID muru_get_fw_blacklist_ctrl_handler(struct cmd_msg *msg, char *rsp_payload, UINT16 rsp_payload_len);
