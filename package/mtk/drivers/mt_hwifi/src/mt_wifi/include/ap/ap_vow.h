...
#define UMAC_FALCON_BWC_GROUP_MIN           40
#define UMAC_FALCON_BWC_GROUP_MAX           (UMAC_BWC_GROUP_MIN + UMAC_BWC_GROUP_NUMBER)
#define UMAC_BWC_GROUP_MIN                  0
#define UMAC_BWC_GROUP_MAX                  (UMAC_BWC_GROUP_MIN + UMAC_BWC_GROUP_NUMBER)
...
#define DL_MULTI_CLIENT_CWMIN		0x4
#define UL_MULTI_CLIENT_CWMAX		0x6
#define UL_MULTI_CLIENT_CWMIN		0x5
...
typedef struct _VOW_MCLI_SCH_CFG_T {
	...
	UINT8	schedule_cond_running;	/* mclisch running status */
	UINT8	cwmin[VOW_TRAFFIC_MODE_MAX];	/* mcli shcedule DL/UL BE cwmin param */
	UINT8	cwmax[VOW_TRAFFIC_MODE_MAX];	/* mcli shcedule DL/UL BE cwmax param */
...
typedef struct _VOW_CR_OFFSET_FOR_GEN_T {
	...
	UINT8 VOW_GEN;
	UINT32 VOW_FEATURE;
	UINT8  VOW_BWC_GROUP_MIN;
	UINT8  VOW_BWC_GROUP_MAX;
...
INT mtk_cfg80211_set_vow_bw_en(
	IN struct _RTMP_ADAPTER *pAd,
	IN UCHAR vow_bw_en);
