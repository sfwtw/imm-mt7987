...
/* The length is the EAPOL-Key frame except MIC and key data field.
      Please refer to 802.11-2020, Figure 12-33 in p.2547.*/
#define MIN_LEN_OF_EAPOL_KEY_FRAME_EXCEPT_MIC 83
...
#define LEN_KEY_DESC_TYPE			1
#define LEN_KEY_DESC_INFO			2
#define LEN_KEY_DESC_LEN			2
#define LEN_KEY_DESC_DATA_LEN			2
