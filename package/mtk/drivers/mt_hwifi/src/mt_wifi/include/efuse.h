...
enum {
	/* eEFUSE_FREE_BLOCK_FORMAT_V1 support 7915, BELLWETHER */
	EFUSE_FREE_BLOCK_FORMAT_V1 = 1,
	/* eEFUSE_FREE_BLOCK_FORMAT_V2 support 7990 */
	EFUSE_FREE_BLOCK_FORMAT_V2 = 2,
};

struct _EFUSE_BANK_INFO {
	UINT32            free_block;
	UINT32            total_block; /* per bank */
	UINT32            efuse_num;
};

#define EFUSE_FREE_BLOCK_SIZE    20
struct _EFUSE_FREE_BLOCK_INFO {
	UINT32			bank_count;
	struct _EFUSE_BANK_INFO	blk_info[EFUSE_FREE_BLOCK_SIZE];
};
