...
#ifdef DOT11_EHT_BE
#define BTWT_REQ_TYPE_RECOMMENDATION_FIELD_VALUE_RTWT      4
#endif /* DOT11_EHT_BE */
...
#define TWT_CTRL_LINKID_BITMAP_PRESENT              BIT(6)
...
#define TWT_CTRL_LINKID_BITMAP_PRESENT_OFFSET       6
...
/* rTWT -> Traffic Info Control field format */
#define RTWT_TRAFFIC_INFO_CTRL_DL_TID_BITMAP_VALID          BIT(0)
#define RTWT_TRAFFIC_INFO_CTRL_UL_TID_BITMAP_VALID          BIT(1)
#define RTWT_TRAFFIC_INFO_CTRL_DL_TID_BITMAP_VALID_OFFSET   0
#define RTWT_TRAFFIC_INFO_CTRL_UL_TID_BITMAP_VALID_OFFSET   1
...
#ifdef DOT11_EHT_BE
struct GNU_PACKED rtwt_para_ext_set {
...
struct GNU_PACKED btwt_para_set_fix {
	UINT16 req_type;
...
struct GNU_PACKED btwt_para_set {
	...
	union {
		UCHAR next_buf[0];
#ifdef DOT11_EHT_BE
		struct rtwt_para_ext_set rtwt_ext_set;
#endif /* DOT11_EHT_BE */
	};
};
...
#define SET_TWT_CTRL_LINKID_BITMAP_PRESENT(wake_dur_unit) \
	(((wake_dur_unit) << TWT_CTRL_LINKID_BITMAP_PRESENT_OFFSET) & \
		TWT_CTRL_LINKID_BITMAP_PRESENT)
...
#define GET_TWT_CTRL_LINKID_BITMAP_PRESENT(control) \
	(((control) & TWT_CTRL_LINKID_BITMAP_PRESENT) >> TWT_CTRL_LINKID_BITMAP_PRESENT_OFFSET)
...
/* TWT element -> rTWT */
#define GET_BTWT_INFO_RTWT_TRAFFIC_INFO_PRESENT(btwt_info) \
	(((btwt_info) & BTWT_INFO_RTWT_TRAFFIC_INFO_PRESENT) >> BTWT_INFO_RTWT_TRAFFIC_INFO_PRESENT_OFFSET)

#define SET_BTWT_INFO_RTWT_TRAFFIC_INFO_PRESENT(p) \
	(((p) << BTWT_INFO_RTWT_TRAFFIC_INFO_PRESENT_OFFSET) & \
		BTWT_INFO_RTWT_TRAFFIC_INFO_PRESENT)

#define SET_BTWT_INFO_RTWT_SCHEDULE_INFO(p) \
	(((p) << BTWT_INFO_RTWT_SCHEDULE_INFO_OFFSET) & \
		BTWT_INFO_RTWT_SCHEDULE_INFO)

#define GET_BTWT_INFO_RTWT_SCHEDULE_INFO(btwt_info) \
	(((btwt_info) & BTWT_INFO_RTWT_SCHEDULE_INFO) >> BTWT_INFO_RTWT_SCHEDULE_INFO_OFFSET)

#define GET_TRAFFIC_INFO_CTRL_DL_TID_BITMAP_VALID(traffic_info) \
	(((traffic_info) & RTWT_TRAFFIC_INFO_CTRL_DL_TID_BITMAP_VALID) >> RTWT_TRAFFIC_INFO_CTRL_DL_TID_BITMAP_VALID_OFFSET)

#define GET_TRAFFIC_INFO_CTRL_UL_TID_BITMAP_VALID(traffic_info) \
	(((traffic_info) & RTWT_TRAFFIC_INFO_CTRL_UL_TID_BITMAP_VALID) >> RTWT_TRAFFIC_INFO_CTRL_UL_TID_BITMAP_VALID_OFFSET)
...
#define SET_PEER_JOIN_BTWT_ID(entry, btwt_id) \
	((entry->twt_ctrl.twt_btwt_id_bitmap) |= (1 << btwt_id))

#define SET_PEER_LEAVE_BTWT_ID(entry, btwt_id) \
	((entry->twt_ctrl.twt_btwt_id_bitmap) &= ~(1 << btwt_id))

#define SET_PEER_LEAVE_ALL_BTWT(entry) \
	(entry->twt_ctrl.twt_btwt_id_bitmap = 0)

#define GET_PEER_JOIN_ANY_BTWT(entry) \
	((entry->twt_ctrl.twt_btwt_id_bitmap) ? TRUE : FALSE)

#define GET_PEER_JOIN_BTWT_ID(entry, btwt_id) \
	((entry->twt_ctrl.twt_btwt_id_bitmap & (1 << btwt_id)) ? TRUE : FALSE)

#define GET_PEER_BTWT_ID_BITMAP(entry) \
	(entry->twt_ctrl.twt_btwt_id_bitmap)
