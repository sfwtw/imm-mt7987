...
void wext_send_dpp_frame_rx_event(PRTMP_ADAPTER pAd, struct wifi_dev *wdev, UINT32 frm_count);
...
INT wapp_send_sr_support_mode_query_rsp(PRTMP_ADAPTER pAd, UINT32 value);
