...
INT32 MtCmdPhyGetRxRate(RTMP_ADAPTER *pAd, UCHAR ucPhyStateInfoCatg, UINT8 ucBandIdx, UINT16 u2Wcid, UINT32 *prRxRateInfo);
...
INT32 MtCmdGetRssi(RTMP_ADAPTER *pAd, UINT16 u2WlanIdx, UINT32 *rssi_rpt);
