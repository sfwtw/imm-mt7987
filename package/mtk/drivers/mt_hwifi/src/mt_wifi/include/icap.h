...
#define ICS_TRIGGER											0
#define ICS_TIMER											1

#define ICS_BAND											0
#define ICS_PARTITION										1
#define ICS_EVENT_GROUP										2
#define ICS_EVENT_ID_MSB									3
#define ICS_EVENT_ID_LSB									4
...
typedef enum _ENUM_SPECTRUM_CTRL_FUNCID_T {
	...
	SPECTRUM_CTRL_FUNCID_SET_PHY_ICS_EVENT_ENABLE
