...
typedef enum {
	...
	WLAN_HOOK_RESUME,
	WLAN_HOOK_HB_CHK,
	WLAN_HOOK_WARP_512_SUPPORT,
	WLAN_HOOK_TX_OS_TO_DRIVER,
	WLAN_HOOK_TX_DRIVER_TO_HWIFI,
	WLAN_HOOK_RX_HWIFI_TO_DRIVER,
	WLAN_HOOK_RX_DRIVER_FORWARD,
	WLAN_HOOK_RX_DRIVER_TO_OS,
	WLAN_HOOK_DRIVER_FREE_PKT,
	WLAN_HOOK_TX_CMD_TO_HWIFI,
	WLAN_HOOK_RX_EVENT_FROM_HWIFI,
	WLAN_HOOK_TRACE,
	WLAN_HOOK_END
} WLAN_HOOK_PT;
