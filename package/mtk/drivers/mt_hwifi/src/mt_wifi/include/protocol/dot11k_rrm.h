...
#define IE_TSF_INFORMATION				1
#define IE_CONDENSED_COUNTRY_STRING		2
#define IE_BSS_CANDIDATE_PREFERENCE		3
...
typedef union GNU_PACKED _RRM_BSSID_INFO {
	struct GNU_PACKED {
		...
		UINT32 Reserved:10;
		UINT32 EHT:1;
		UINT32 _6G_CO_locatedAP:1;
		UINT32 OCT_Support:1;
		UINT32 _2G5G_CO_locatedAP:1;
