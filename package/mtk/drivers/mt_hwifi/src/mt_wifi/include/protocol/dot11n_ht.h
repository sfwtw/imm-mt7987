...
typedef struct GNU_PACKED _HT_CAPABILITY_IE {
	...
	HT_BF_CAP		TxBFCap;	/* beamforming cap. */
...
enum ht_ampdu_length_exponent {
	HT_AMPDU_2_OF_POWER_13_M1 = 0,
	HT_AMPDU_2_OF_POWER_14_M1,
	HT_AMPDU_2_OF_POWER_15_M1,
	HT_AMPDU_2_OF_POWER_16_M1
};
