...
#define RTMP_DRIVER_CFG80211_REGISTER(__pNetDev) \
	{ \
		struct _RTMP_ADAPTER *__pAd = NULL; \
		GET_PAD_FROM_NET_DEV(__pAd, __pNetDev); \
		if (__pAd->net_dev == __pNetDev) \
			CFG80211_Register(__pAd, rtmp_get_dev(__pAd), __pNetDev); \
	}
...
#endif /* APCLI_CFG80211_SUPPORT */
#define RTMP_DRIVER_80211_AP_SCAN(__pAd, __pData) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_AP_SITE_SURVEY, 0, __pData, 0)
...
#define RTMP_DRIVER_80211_MCAST_RATE_SET(__pAd, __pTransmit, __apidx) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_80211_MCAST_RATE_SET, 0, __pTransmit, __apidx)

#define RTMP_DRIVER_80211_BSS_COLOR_CHANGE(__pAd, __pParams, __apidx) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_80211_BSS_COLOR_CHANGE, 0, __pParams, __apidx)

#define RTMP_DRIVER_80211_FT_IES_UPDATE(__pAd, __pFTies, __apidx) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_80211_FT_IES_UPDATE, 0, __pFTies, __apidx)
...
#define RTMP_DRIVER_80211_AP_BEACON_KEY_DEFAULT_SET(__pAd, __KeyId)				\
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_80211_AP_BEACON_KEY_DEFAULT_SET, 0, NULL, __KeyId)
