...
/*Channel Priority Definitions*/
#define CHAN_PRIO_UNAVAILABLE	0
#define CHAN_PRIO_MAXIMUM	14
#define CHAN_PRIO_UNSPECIFIED	0XFF
...
#define CFG80211_NUM_OF_CHAN_5GHZ			28 // 35 for Japan Channels
#else
#define CFG80211_NUM_OF_CHAN_5GHZ			35
#endif
