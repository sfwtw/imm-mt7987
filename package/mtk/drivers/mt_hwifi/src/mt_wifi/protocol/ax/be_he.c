...
VOID wlan_operate_set_unsolicit_tx_type(struct wifi_dev *wdev, UINT8 tx_type)
{
	...
	if (op)
		op->he_oper.ap6g.unsolicit_tx_type = tx_type;
}
...
VOID wlan_operate_set_unsolicit_tx_mode(struct wifi_dev *wdev, UINT8 tx_mode)
{
	...
	if (op)
		op->he_oper.ap6g.unsolicit_tx_mode = tx_mode;
}
...
VOID wlan_operate_set_unsolicit_tx_tu(struct wifi_dev *wdev, UINT8 tx_tu)
{
	...
	if (op)
		op->he_oper.ap6g.unsolicit_tx_tu = tx_tu;
}
...
UINT16 wlan_operate_get_he_txop_dur_rts_thld(struct wifi_dev *wdev)
{
	...
	MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_HE, DBG_LVL_DEBUG,
			"txop_dur_rts_thld = %d\n",
			ret);
	return ret;
}
...
UINT8 wlan_operate_get_unsolicit_tx_tu(struct wifi_dev *wdev)
{
	...
	return op->he_oper.ap6g.unsolicit_tx_tu;
}
...
UINT8 wlan_operate_get_unsolicit_tx_mode(struct wifi_dev *wdev)
{
	...
	return op->he_oper.ap6g.unsolicit_tx_mode;
}
...
UINT8 wlan_operate_get_unsolicit_tx_type(struct wifi_dev *wdev)
{
	...
	return op->he_oper.ap6g.unsolicit_tx_type;
}
