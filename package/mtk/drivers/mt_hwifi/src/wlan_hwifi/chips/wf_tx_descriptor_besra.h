// generate by structure_parser.py at 2021-04-09 13:14:12
...
// ----------------- WF_TX_DESCRIPTOR Bit Field Definitions -----------------
...
typedef PACKING union
{
    PACKING struct
    {
        FIELD rsvd_00_00                :  1; //  0- 0
        FIELD amsdu_cap_utxb            :  1; //  1- 1
        FIELD das                       :  1; //  2- 2
        FIELD dis_mat                   :  1; //  3- 3
        FIELD msdu_count                :  6; //  9- 4
...
// ----------------- WF_TX_DESCRIPTOR Grouping Definitions  -----------------
// ----------------- WF_TX_DESCRIPTOR Register Definition   -----------------
...
// ----------------- WF_TX_DESCRIPTOR Enum Definitions      -----------------
// ----------------- WF_TX_DESCRIPTOR C Macro Definitions   -----------------
...
#define HAL_TX_DESC_GET_DP(reg32)                                                                           READ_FIELD((reg32), WF_TX_DESCRIPTOR_DP)
...
// DW8
#define HAL_TX_DESC_GET_MSDU0(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU0)
#define HAL_TX_DESC_GET_MSDU1(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU1)
// DW9
#define HAL_TX_DESC_GET_MSDU2(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU2)
#define HAL_TX_DESC_GET_MSDU3(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU3)
// DW10
...
// DO NOT process repeat field(txp[3])
// DW16
#define HAL_TX_DESC_GET_MSDU4(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU4)
#define HAL_TX_DESC_GET_MSDU5(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU5)
// DW17
#define HAL_TX_DESC_GET_MSDU6(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU6)
#define HAL_TX_DESC_GET_MSDU7(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU7)
// DW18
...
// DW31
// DO NOT process repeat field(txp[12])
#define HAL_TX_DESC_GET_TXP13(reg32)                                                                        READ_FIELD((reg32), WF_TX_DESCRIPTOR_TXP13)
// DW32
// DO NOT process repeat field(txp[13])
// DW33
...
#define HAL_TX_DESC_SET_DP(reg32, val32)                                                                    WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_DP, val32)
...
// DW8
#define HAL_TX_DESC_SET_MSDU0(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU0, val32)
#define HAL_TX_DESC_SET_MSDU1(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU1, val32)
// DW9
#define HAL_TX_DESC_SET_MSDU2(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU2, val32)
#define HAL_TX_DESC_SET_MSDU3(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU3, val32)
// DW10
...
// DO NOT process repeat field(txp[3])
// DW16
#define HAL_TX_DESC_SET_MSDU4(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU4, val32)
#define HAL_TX_DESC_SET_MSDU5(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU5, val32)
// DW17
#define HAL_TX_DESC_SET_MSDU6(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU6, val32)
#define HAL_TX_DESC_SET_MSDU7(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU7, val32)
// DW18
...
// DW31
// DO NOT process repeat field(txp[12])
#define HAL_TX_DESC_SET_TXP13(reg32, val32)                                                                 WRITE_FIELD((reg32), WF_TX_DESCRIPTOR_TXP13, val32)
// DW32
// DO NOT process repeat field(txp[13])
// DW33
...
#define HAL_TX_DESC_CLR_DP(reg32)                                                                           CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_DP)
...
// DW8
#define HAL_TX_DESC_CLR_MSDU0(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU0)
#define HAL_TX_DESC_CLR_MSDU1(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU1)
// DW9
#define HAL_TX_DESC_CLR_MSDU2(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU2)
#define HAL_TX_DESC_CLR_MSDU3(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU3)
// DW10
...
// DO NOT process repeat field(txp[3])
// DW16
#define HAL_TX_DESC_CLR_MSDU4(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU4)
#define HAL_TX_DESC_CLR_MSDU5(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU5)
// DW17
#define HAL_TX_DESC_CLR_MSDU6(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU6)
#define HAL_TX_DESC_CLR_MSDU7(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_MSDU7)
// DW18
...
// DW31
// DO NOT process repeat field(txp[12])
#define HAL_TX_DESC_CLR_TXP13(reg32)                                                                        CLEAR_FIELD((reg32), WF_TX_DESCRIPTOR_TXP13)
// DW32
// DO NOT process repeat field(txp[13])
// DW33
