...
#ifdef DBG
VOID ATE_QA_Statistics(struct _RTMP_ADAPTER *pAd, union _RXWI_STRUC *pRxWI, struct _RXINFO_STRUC *pRxInfo, PHEADER_802_11 pHeader);
#ifdef WCX_SUPPORT
...
INT32 SetATEChPowerOffset(struct _RTMP_ADAPTER *pAd, RTMP_STRING *Arg);
INT32 SetATECvtPowerOffset(struct _RTMP_ADAPTER *pAd, RTMP_STRING *Arg);
...
INT32 SetATEPreamPunc(struct _RTMP_ADAPTER *pAd, RTMP_STRING *Arg);
