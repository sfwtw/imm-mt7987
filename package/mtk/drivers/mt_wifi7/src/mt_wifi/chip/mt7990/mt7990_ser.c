...
#include "mt7990_coda/wf_cr_sw_def.h"
#include "chip/mt7990_cr.h"

#ifdef ERR_RECOVERY
void mt7990_ser_1_0_v1(struct ser_cb_t *ser_cb)
{
...
void mt7990_ser_10_0_v1(struct ser_cb_t *ser_cb)
{
	UINT32 chip_id = ser_cb->chip_id;
	UINT32 hw_id = ser_cb->hw_id;
	struct _RTMP_ADAPTER *pAd_list[MAX_NUM_OF_INF] = {NULL};
...
void mt7990_ser_0_5_v1(struct ser_cb_t *ser_cb)
{
	UINT32 chip_id = ser_cb->chip_id;
	UINT32 hw_id = ser_cb->hw_id;
	UINT8 level = ser_cb->ser_level;
...
void mt7990_ser_0_0_v1(struct ser_cb_t *ser_cb)
{
	UINT32 chip_id = ser_cb->chip_id;
	UINT32 hw_id = ser_cb->hw_id;
	UINT8 level = ser_cb->ser_level;
...
void mt7990_dump_ser_stat(struct _RTMP_ADAPTER *ad, UINT8 dump_all)
{
	...
	if (MTK_REV_ET(ad, MT7990, MT7990E1)) {
...
#ifdef MTK_FE_RESET_RECOVER
void mt7990_fe_reset(struct ser_cb_t *ser_cb)
{
	UINT32 chip_id = ser_cb->chip_id;
	UINT32 hw_id = ser_cb->hw_id;
	struct _RTMP_ADAPTER *pAd_list[MAX_NUM_OF_INF] = {NULL};
...
void mt7990_fe_wdma_reset(struct ser_cb_t *ser_cb)
{
	UINT32 chip_id = ser_cb->chip_id;
	UINT32 hw_id = ser_cb->hw_id;
	struct _RTMP_ADAPTER *pAd_list[MAX_NUM_OF_INF] = {NULL};
