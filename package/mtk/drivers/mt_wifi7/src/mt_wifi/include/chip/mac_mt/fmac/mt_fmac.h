...
#include "mac_mt/fmac/fmac_txd.h"
#include "mac_mt/fmac/fmac_rxd.h"
...
#define TXD_ADDR_H_MASK         BITS(12, 13)
#define TXD_ADDR_H_OFFSET       12
...
typedef struct _FRAME_POWER_CONFIG_INFO_T {
	HAL_FRAME_POWER_SET_T ai1FramePowerConfig[TXPOWER_RATE_NUM][CFG_WIFI_RAM_BAND_NUM];
...
VOID mtf_write_tmac_info_fixed_rate(
	...
	UCHAR *tmac_info, struct _MAC_TX_INFO *info,
