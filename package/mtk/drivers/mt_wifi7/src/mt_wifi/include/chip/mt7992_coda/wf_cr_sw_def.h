...
#define WF_SW_DEF_CR_LAMC_WISR7_BN0_STATUS_ADDR (WF_SW_DEF_CR_BASE + 0x064) // 1464
#define WF_SW_DEF_CR_LAMC_WISR7_BN1_STATUS_ADDR (WF_SW_DEF_CR_BASE + 0x068) // 1468
#define WF_SW_DEF_CR_LAMC_WISR7_BN2_STATUS_ADDR (WF_SW_DEF_CR_BASE + 0x06C) // 146C
#define WF_SW_DEF_CR_WFDMA_STATUS_ADDR          (WF_SW_DEF_CR_BASE + 0x070) // 1470
#define WF_SW_DEF_CR_USB_MCU_EVENT_ADD          (WF_SW_DEF_CR_BASE + 0x074) // 1474
#define WF_SW_DEF_CR_USB_HOST_ACK_ADDR          (WF_SW_DEF_CR_BASE + 0x078) // 1478
#define WF_SW_DEF_CR_PM_CHANGE_ADDR             (WF_SW_DEF_CR_BASE + 0x07C) // 147C
