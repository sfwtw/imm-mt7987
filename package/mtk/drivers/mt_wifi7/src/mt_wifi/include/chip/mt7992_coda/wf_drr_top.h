...
#define WF_DRR_TOP_STPCR0_ADDR								   (WF_DRR_TOP_BASE + 0x040) // 8840
#define WF_DRR_TOP_STPCR1_ADDR								   (WF_DRR_TOP_BASE + 0x044) // 8844
#define WF_DRR_TOP_STPCR2_ADDR								   (WF_DRR_TOP_BASE + 0x048) // 8848
#define WF_DRR_TOP_STPCR3_ADDR								   (WF_DRR_TOP_BASE + 0x04C) // 884C
#define WF_DRR_TOP_STPCR4_ADDR								   (WF_DRR_TOP_BASE + 0x050) // 8850
#define WF_DRR_TOP_STACR0_ADDR								   (WF_DRR_TOP_BASE + 0x054) // 8854
#define WF_DRR_TOP_STACR1_ADDR								   (WF_DRR_TOP_BASE + 0x058) // 8858
#define WF_DRR_TOP_STACR2_ADDR								   (WF_DRR_TOP_BASE + 0x05C) // 885C
#define WF_DRR_TOP_STACR3_ADDR								   (WF_DRR_TOP_BASE + 0x060) // 8860
#define WF_DRR_TOP_STACR4_ADDR								   (WF_DRR_TOP_BASE + 0x064) // 8864
#define WF_DRR_TOP_STGCR_ADDR								   (WF_DRR_TOP_BASE + 0x06C) // 886C
