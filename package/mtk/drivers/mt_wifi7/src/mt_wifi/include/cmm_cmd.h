...
#define MAX_LEN_OF_CMD_QUEUE            512
#if (NR_CPUS > 1)
#define CMD_QUEUE_SCH			32
#else
...
enum {
	...
	CMDTHRED_FW_LOG_OPEN_CLOSE_FILE,
	CMDTHRED_FW_LOG_TO_FILE,
	CMDTHRED_FW_LOG_ALLOC_MEMORY,
	CMDTHRED_FW_LOG_TO_MEMORY,
#ifdef MBO_SUPPORT
	CMDTHREAD_BSS_TERM,
#endif
...
#endif
	CMDTHREAD_APCLI_MLO_CSA_SWITCH_CHANNEL,
	CMDTHREAD_DROP_RADAR_EVENT,
#ifdef DOT11_EHT_BE
	CMDTHREAD_MLD_RECONFIG_TIMEOUT,
	CMDTHREAD_MLD_AT2LM_TIMEOUT,
#endif /* DOT11_EHT_BE */
	CMDTHREAD_BSS_RECONF_SM,
	CMDTHREAD_FORCE_SCAN_STOP,
