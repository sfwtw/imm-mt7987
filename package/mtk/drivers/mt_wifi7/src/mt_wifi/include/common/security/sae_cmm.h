...
#define IS_SAE_COMMIT_STATUS_SUCCESS(_status) \
(_status == MLME_SUCCESS || \
_status == MLME_SAE_HASH_TO_ELEMENT || \
_status == MLME_SAE_PUBLIC_KEY || \
_status == MLME_ANTI_CLOGGING_TOKEN_REQ || \
_status == MLME_FINITE_CYCLIC_GROUP_NOT_SUPPORTED)
...
struct __SAE_INSTANCE {
	...
	UCHAR mld_own_mac[MAC_ADDR_LEN];
	UCHAR mld_peer_mac[MAC_ADDR_LEN];
	UCHAR *psk;
