...
#define I2C_EEPROM_BLOCK			1024

#define EEPROM_SIZE					0x1E00
...
typedef struct eeprom_flash_info_t {
	...
	RTMP_STRING	eeprom_default_bin_path[L2PROFILE_PATH_LEN];
} eeprom_flash_info;
...
/* Include NIC Config 0, 1, CR, TX ALC step, BBPs */
...
/* 20MHZ AND 40 MHZ use different power. This is delta in 40MHZ. */
...
#define EEPROM_BAND_SELECT_BAND			0x190
#define BAND_SELECT_BAND0_MASK			(0x7)
#define BAND_SELECT_BAND0_OFFSET		0
#define BAND_SELECT_BAND1_MASK			(0x38)
#define BAND_SELECT_BAND1_OFFSET		3
#define BAND_SELECT_BAND2_MASK			(0x700)
#define BAND_SELECT_BAND2_OFFSET		8

enum BAND_SELECT_BAND_MODE {
	BAND_SELECT_BAND_NONE,
	BAND_SELECT_BAND_2G,
	BAND_SELECT_BAND_5G,
	BAND_SELECT_BAND_6G,
	BAND_SELECT_BAND_5G_LOW,
	BAND_SELECT_BAND_5G_HIGH,
	BAND_SELECT_BAND_6G_LOW,
	BAND_SELECT_BAND_6G_HIGH,
	BAND_SELECT_BAND_MAX,
};
...
/* The address is from NIC config 0, not BBP register ID */
#define EEPROM_BBP_BASE_OFFSET			0xf0

/* */
/* Bit mask for the Tx ALC and the Tx fine power control */
/* Valid: 0~31, and in 0.5dB step */
#define GET_TX_ALC_BIT_MASK					0x1F
/* Valid: 0~4, and in 0.1dB step */
#define GET_TX_FINE_POWER_CTRL_BIT_MASK	0xE0
/* The length, in bit, of the Tx ALC field */
#define NUMBER_OF_BITS_FOR_TX_ALC			5
...
INT rtmp_ee_write_to_i2c_eeprom(struct _RTMP_ADAPTER *pAd);
...
INT show_bandinfo_proc(struct _RTMP_ADAPTER *pAd, RTMP_STRING *arg);
...
/*************************************************************************
  ...
  ************************************************************************/
INT RtmpChipOpsEepromHook(struct _RTMP_ADAPTER *pAd, INT forceMode);

INT NICReadEEPROMParameters(
	struct _RTMP_ADAPTER *pAd, RTMP_STRING *mac_addr, BOOLEAN is_cal);
