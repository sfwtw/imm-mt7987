...
#if defined(IGMP_SNOOPING_DENY_LIST)
...
#endif
INT Set_Igmp_Flooding_CIDR(RTMP_ADAPTER *pAd, UCHAR *white_list);
#endif
...
extern PMULTICAST_FILTER_TABLE m2u_pMulticastFilterTable;
