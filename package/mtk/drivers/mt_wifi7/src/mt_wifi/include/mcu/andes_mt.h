...
VOID EventThermalProtInfo(struct _RTMP_ADAPTER *pAd, char *Data, UINT16 Len);
VOID EventThermalProtDutyInfo(struct _RTMP_ADAPTER *pAd, char *Data, UINT16 Len);
