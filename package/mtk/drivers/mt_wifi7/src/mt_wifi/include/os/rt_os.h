...
/* SIOCDEVPRIVATE and SIOCIWFIRSTPRIV always exist in sockios.h and wireless.h
	until latest kernel v8.5 */
#if (KERNEL_VERSION(8, 5, 0) > LINUX_VERSION_CODE)
...
#define RTPRIV_IOCTL_TESTENGINE						(SIOCIWFIRSTPRIV + 0x0B)
#endif /* WCX_SUPPORT */
