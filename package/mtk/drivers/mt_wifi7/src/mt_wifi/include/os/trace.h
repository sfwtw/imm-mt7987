...
TRACE_EVENT(tr_entry,
	...
	TP_fast_assign(
		...
		__entry->non_qos_seq = tr_entry->seq_ctrl.NonQosDataSeq;
		__entry->qos_seq_tid_0 = tr_entry->seq_ctrl.TxSeq[0];
		__entry->qos_seq_tid_1 = tr_entry->seq_ctrl.TxSeq[1];
		__entry->qos_seq_tid_2 = tr_entry->seq_ctrl.TxSeq[2];
		__entry->qos_seq_tid_3 = tr_entry->seq_ctrl.TxSeq[3];
		__entry->qos_seq_tid_4 = tr_entry->seq_ctrl.TxSeq[4];
		__entry->qos_seq_tid_5 = tr_entry->seq_ctrl.TxSeq[5];
		__entry->qos_seq_tid_6 = tr_entry->seq_ctrl.TxSeq[6];
		__entry->qos_seq_tid_7 = tr_entry->seq_ctrl.TxSeq[7];
