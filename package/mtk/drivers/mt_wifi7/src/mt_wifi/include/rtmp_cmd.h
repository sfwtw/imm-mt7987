...
typedef enum _CMD_RTPRIV_IOCTL_COMMON {
	...
	CMD_RTPRIV_IOCTL_80211_AP_BEACON_KEY_DEFAULT_SET,
	...
	CMD_RTPRIV_IOCTL_80211_MCAST_RATE_SET,
	CMD_RTPRIV_IOCTL_80211_BSS_COLOR_CHANGE,
	CMD_RTPRIV_IOCTL_80211_FT_IES_UPDATE,
...
#endif
	CMD_RTPRIV_IOCTL_AP_SITE_SURVEY,
	...
	CMD_RTPRIV_IOCTL_ACTION_MON_INIT,
	CMD_RTPRIV_IOCTL_ACTION_MON_OPEN,
	CMD_RTPRIV_IOCTL_ACTION_MON_CLOSE,
	CMD_RTPRIV_IOCTL_ACTION_MON_REMOVE,
#endif
...
/* cfg parameters used for bcn */
struct CMD_RTPRIV_IOCTL_80211_BEACON_CFG {
	INT32 interval;
	INT32 dtim_period;
...
/* used for bcn ies */
struct CMD_RTPRIV_IOCTL_80211_BEACON {
	UCHAR *beacon_head;
	UCHAR *beacon_tail;
...
#define RT_CMD_80211_CHANTYPE_VHT80P80	0x05
#define RT_CMD_80211_CHANTYPE_VHT160	0x06
...
typedef struct __CMD_RTPRIV_IOCTL_80211_STA {
	...
	INT8 ack_signal;
	UINT8 chains;
	INT8 chain_signal[IEEE80211_MAX_CHAINS];
...
#define RT_CMD_80211_KEY_AES_GMAC128		0x04
#define RT_CMD_80211_KEY_AES_GMAC256		0x05
#define RT_CMD_80211_KEY_AES_CMAC256		0x06
...
typedef struct __RT_CMD_STATS {
	...
	OUT unsigned long rx_drop_count;
	OUT unsigned long tx_drop_count;
...
typedef struct __RT_CMD_AP_IOCTL_UPDATE_PMKID {
	...
	UCHAR sta[ETH_ALEN];
	UCHAR link_addr[ETH_ALEN];
	UCHAR pmkid[LEN_PMKID];
	UCHAR AddRemove;	/*1- ADD, 0- Remove*/
} RT_CMD_AP_IOCTL_UPDATE_PMKID;
#endif /*HOSTAPD_PMKID_IN_DRIVER_SUPPORT*/
#ifdef RT_CFG80211_SUPPORT
struct __RT_CMD_AP_IOCTL_UPDATE_STA_MAC {
	UCHAR sta[ETH_ALEN];
};
#endif
