...
################################################################
ifeq ($(PLATFORM),RMI)
	WFLAGS += -DCFG_BIG_ENDIAN
endif

ifeq ($(PLATFORM),UBICOM_IPX8)
	WFLAGS += -DCFG_BIG_ENDIAN -DUNALIGNMENT_SUPPORT -DPLATFORM_UBM_IPX8 -DNO_CONSISTENT_MEM_SUPPORT -DCACHE_LINE_32B
endif
...
ifeq ($(PLATFORM),IKANOS_V160)
	WFLAGS += -DCFG_BIG_ENDIAN -DIKANOS_VX_1X0
endif
...
ifeq ($(PLATFORM),INF_TWINPASS)
	WFLAGS += -DCFG_BIG_ENDIAN -DINF_TWINPASS
endif

ifeq ($(PLATFORM),INF_DANUBE)
	ifneq (,$(findstring 2.4,$(LINUX_SRC)))
	# Linux 2.4
	WFLAGS += -DINF_DANUBE -DCFG_BIG_ENDIAN
	else
	# Linux 2.6
	WFLAGS += -DCFG_BIG_ENDIAN
	endif
...
ifeq ($(PLATFORM),BRCM_6358)
	WFLAGS += -DCFG_BIG_ENDIAN -DBRCM_6358
endif
