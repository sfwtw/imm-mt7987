...
//[Revision time]   : Tue May 24 18:52:28 2022
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL0_ADDR     (WF_WFDMA_HOST_DMA0_BASE + 0xB60) // 4B60
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL1_ADDR     (WF_WFDMA_HOST_DMA0_BASE + 0xB64) // 4B64
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_ADDR     (WF_WFDMA_HOST_DMA0_BASE + 0xB68) // 4B68
...
/* =====================================================================================
  ...
  ---HOST_INT_STA_EXT (0x18024000 + 0x118)---
    ...
    rx_done_int_sts_11[11]       - (W1C) RX Queue#11 packet receive interrupt
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
    rx_done_int_sts_12[12]       - (W1C) RX Queue#12 packet receive interrupt
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
    tx_done_int_sts_19[13]       - (W1C) TX Queue#19 packet transmit interrupt
                                     Write 1 to clear the interrupt
    RESERVED14[14]               - (RO) Reserved bits
    tx_done_int_sts_21[15]       - (W1C) TX Queue#21 packet transmit interrupt
                                     Write 1 to clear the interrupt
    tx_done_int_sts_22[16]       - (W1C) TX Queue#22 packet transmit interrupt
                                     Write 1 to clear the interrupt
    RESERVED17[18..17]           - (RO) Reserved bits
    rx_done_int_sts_3[19]        - (W1C) RX Queue#3 packet receive interrupt 
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
    ...
    rx_done_int_sts_7[26]        - (W1C) RX Queue#7 packet receive interrupt 
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
...
/* =====================================================================================
  ...
  ---HOST_INT_ENA_EXT (0x18024000 + 0x11C)---
    ...
    HOST_RX_DONE_INT_ENA12[12]   - (RW) RX Queue#12 packet receive interrupt
    HOST_TX_DONE_INT_ENA19[13]   - (RW) TX Queue#19 packet transmit interrupt
    RESERVED14[14]               - (RO) Reserved bits
    HOST_TX_DONE_INT_ENA21[15]   - (RW) TX Queue#21 packet transmit interrupt
    HOST_TX_DONE_INT_ENA22[16]   - (RW) TX Queue#22 packet transmit interrupt
    RESERVED17[18..17]           - (RO) Reserved bits
    HOST_RX_DONE_INT_ENA3[19]    - (RW) RX Queue#3 packet receive interrupt
    ...
    RESERVED25[25]               - (RO) Reserved bits
    HOST_RX_DONE_INT_ENA7[26]    - (RW) RX Queue#7 packet receive interrupt
    RESERVED27[27]               - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---HOST_TX_INT_PCIE_SEL (0x18024000 + 0x150)---

    HOST_TX_DONE_INT_PCIE_SEL[31..0] - (RW) Tx Ring interrupt PCIe selection
                                     0: send interrupt from current PCIe
                                     1: send interrupt from the other PCIe
...
/* =====================================================================================
  ...
  ---HOST_RX_INT_PCIE_SEL (0x18024000 + 0x154)---

    HOST_RX_DONE_INT_PCIE_SEL[31..0] - (RW) Rx Ring interrupt PCIe selection
                                     0: send interrupt from current PCIe
                                     1: send interrupt from the other PCIe
...
/* =====================================================================================
  ...
  ---HOST_INT_STA (0x18024000 + 0x200)---
    ...
    tx_done_int_sts_6[10]        - (W1C) TX Queue#6 packet receive interrupt
                                     Write 1 to clear the interrupt
                                     Read to get the raw interrupt status
    wf_rro_irq_sts[11]           - (W1C) RRO packet receive interrupt 
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
    ...
    tx_coherent_int_sts[21]      - (W1C) TX_DMA finds data coherent event when checking ddone bit
                                     Write 1 to clear the interrupt
                                     Read to get the raw interrupt status
    tx_done_int_sts_20[22]       - (W1C) TX Queue#20 packet receive interrupt
                                     Write 1 to clear the interrupt
                                     Read to get the raw interrupt status
    rx_done_int_sts_12[23]       - (W1C) RX Queue#12 packet receive interrupt
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
    wpdma2host_err_int_sts[24]   - (RO) wpdma interrupt overall status
                                     User should should check WPDMA_ERR_INT_STA for each wpdma error interrupt status 
...
/* =====================================================================================
  ...
  ---HOST_INT_ENA (0x18024000 + 0X204)---
    ...
    WF_RRO_IRQ_ENA[11]           - (RW) RRO packet receive interrupt
    ...
    HOST_RX_COHERENT_EN[20]      - (RW) Enable for RX_DMA data coherent interrupt
    HOST_TX_COHERENT_EN[21]      - (RW) Enable for TX_DMA data coherent interrupt
    HOST_TX_DONE_INT_ENA20[22]   - (RW) TX Queue#20 packet receive interrupt
    HOST_RX_DONE_INT_ENA12[23]   - (RW) RX Queue#12 packet receive interrupt
    wpdma2host_err_int_ena[24]   - (RW) Enable bit of wpdma2host_err_int
    RESERVED25[25]               - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---HOST_INT_ENA_SET (0x18024000 + 0X228)---
    ...
    WF_RRO_IRQ_ENA[11]           - (W1S) RRO packet receive interrupt
    ...
    HOST_TX_DONE_INT_ENA20[22]   - (W1S) TX Queue#20 packet transmit interrupt
    HOST_RX_DONE_INT_ENA12[23]   - (RW) RX Queue#12 packet receive interrupt
...
/* =====================================================================================
  ...
  ---HOST_INT_ENA_CLR (0x18024000 + 0X22C)---
    ...
    WF_RRO_IRQ_ENA[11]           - (W1C) RRO packet receive interrupt
    ...
    HOST_TX_DONE_INT_ENA20[22]   - (W1C) TX Queue#20 packet transmit interrupt
    HOST_RX_DONE_INT_ENA12[23]   - (RW) RX Queue#12 packet receive interrupt
...
/* =====================================================================================
 ...
 =====================================================================================*/
#define WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_CSR_RRO_DMAD_PREFETCH_TIMER_ADDR WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_ADDR
#define WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_CSR_RRO_DMAD_PREFETCH_TIMER_MASK 0x00F00000                // CSR_RRO_DMAD_PREFETCH_TIMER[23..20]
#define WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_CSR_RRO_DMAD_PREFETCH_TIMER_SHFT 20
...
#define WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_CSR_RRO_BLINK_PLINK_MODE_ADDR WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_ADDR
#define WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_CSR_RRO_BLINK_PLINK_MODE_MASK 0x00002000                // CSR_RRO_BLINK_PLINK_MODE[13]
#define WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT2_CSR_RRO_BLINK_PLINK_MODE_SHFT 13
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_CTRL0 (0x18024000 + 0x460)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_CTRL1 (0x18024000 + 0x464)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_CTRL2 (0x18024000 + 0x468)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_CTRL3 (0x18024000 + 0x46c)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_CTRL0 (0x18024000 + 0x5C0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_CTRL1 (0x18024000 + 0x5C4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_CTRL2 (0x18024000 + 0x5C8)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_CTRL3 (0x18024000 + 0x5CC)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_EXT_CTRL (0x18024000 + 0x658)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_EXT_CTRL (0x18024000 + 0x6B0)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_BKRS_CTRL0 (0x18024000 + 0xB60)---
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL0_pf_didx_idx_MASK 0x0FFF0000                // pf_didx_idx[27..16]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL0_pf_didx_idx_SHFT 16
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL0_pld_didx_idx_MASK 0x00000FFF                // pld_didx_idx[11..0]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL0_pld_didx_idx_SHFT 0

/* =====================================================================================

  ---WPDMA_TX_RING22_BKRS_CTRL1 (0x18024000 + 0xB64)---
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL1_disp_didx_idx_MASK 0x00FF0000                // disp_didx_idx[23..16]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL1_disp_didx_idx_SHFT 16
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL1_disp_cidx_idx_MASK 0x000000FF                // disp_cidx_idx[7..0]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL1_disp_cidx_idx_SHFT 0

/* =====================================================================================

  ---WPDMA_TX_RING22_BKRS_CTRL2 (0x18024000 + 0xB68)---
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_disp_ring_vld_MASK 0x00080000                // disp_ring_vld[19]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_disp_ring_vld_SHFT 19
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pf_dq_ring_empty_MASK 0x00040000                // pf_dq_ring_empty[18]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pf_dq_ring_empty_SHFT 18
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pf_ring_empty_MASK 0x00020000                // pf_ring_empty[17]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pf_ring_empty_SHFT 17
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pld_ring_empty_MASK 0x00010000                // pld_ring_empty[16]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pld_ring_empty_SHFT 16
...
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pld_cidx_idx_MASK 0x00000FFF                // pld_cidx_idx[11..0]
#define WF_WFDMA_HOST_DMA0_WPDMA_TX_RING22_BKRS_CTRL2_pld_cidx_idx_SHFT 0
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING9_BKRS_CTRL0 (0x18024000 + 0xC90)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING9_BKRS_CTRL1 (0x18024000 + 0xC94)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING9_BKRS_CTRL2 (0x18024000 + 0xC98)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING10_BKRS_CTRL0 (0x18024000 + 0xCA0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING10_BKRS_CTRL1 (0x18024000 + 0xCA4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING10_BKRS_CTRL2 (0x18024000 + 0xCA8)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING11_BKRS_CTRL0 (0x18024000 + 0xCB0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING11_BKRS_CTRL1 (0x18024000 + 0xCB4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING11_BKRS_CTRL2 (0x18024000 + 0xCB8)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_BKRS_CTRL0 (0x18024000 + 0xCC0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_BKRS_CTRL1 (0x18024000 + 0xCC4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_BKRS_CTRL2 (0x18024000 + 0xCC8)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_DMAD_MIB (0x18024000 + 0xE60)---
...
/* =====================================================================================
  ...
  ---WPDMA_TX_RING22_PKT_MIB (0x18024000 + 0xE64)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING8_DMAD_MIB (0x18024000 + 0xF80)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING8_PKT_MIB (0x18024000 + 0xF84)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING9_DMAD_MIB (0x18024000 + 0xF90)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING9_PKT_MIB (0x18024000 + 0xF94)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING10_DMAD_MIB (0x18024000 + 0xFA0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING10_PKT_MIB (0x18024000 + 0xFA4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING11_DMAD_MIB (0x18024000 + 0xFB0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING11_PKT_MIB (0x18024000 + 0xFB4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_DMAD_MIB (0x18024000 + 0xFC0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_PKT_MIB (0x18024000 + 0xFC4)---
